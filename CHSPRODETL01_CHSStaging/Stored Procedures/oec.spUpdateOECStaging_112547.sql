...
CREATE PROC [oec].[spUpdateOECStaging_112547]
AS
     SET NOCOUNT ON;
     SET XACT_ABORT ON;
    ...
    UPDATE oec.AdvanceOECRaw_112547 
    SET ProviderPhone = REPLACE(REPLACE(REPLACE(REPLACE(ProviderPhone,'-',''),'(',''),')',''),' ',''),
	   ...
	   --SELECT memberdob, CONVERT(VARCHAR(10),CONVERT(DATE,MemberDOB),112) FROM oec.AdvanceOECRaw_112547
    ...
    SET H_OEC_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))) ))), 2)),
	   ...
	   S_OECDetail_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(FileName, ''))), ':', RTRIM(LTRIM(COALESCE(LoadDate, ''))), ':', RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberHICN, ''))), ':', RTRIM(LTRIM(COALESCE(DiagnosisCode, ''))), ':', RTRIM(LTRIM(COALESCE(ICD9_ICD10_Ind, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))), ':', RTRIM(LTRIM(COALESCE(CONTRACT_CODE, ''))), ':', RTRIM(LTRIM(COALESCE(ClaimID, ''))), ':', RTRIM(LTRIM(COALESCE(ChaseID, ''))), ':', RTRIM(LTRIM(COALESCE(MedicalRecordID, ''))), ':', RTRIM(LTRIM(COALESCE(ChasePriority, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderRelationsRep, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty, ''))) ))), 2)),
	   ...
	   L_MemberOEC_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(CentauriMemberID, ''))), ':', RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, '')))))), 2)),
	   ...
	   L_OECProjectOEC_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))) ))), 2)),
	   ...
	   L_OECVendorLocation_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))),':',RTRIM(LTRIM(COALESCE(VendorID,''))),':',RTRIM(LTRIM(COALESCE(VendorAddress ,''))),':',RTRIM(LTRIM(COALESCE(VendorCity,''))),':',RTRIM(LTRIM(COALESCE(VendorState,''))),':',RTRIM(LTRIM(COALESCE(VendorZip,'')))))),2)),
	   L_OECProviderContact_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))),':',RTRIM(LTRIM(COALESCE(CentauriProviderID,''))),':',RTRIM(LTRIM(COALESCE(ProviderPhone ,''))),':',RTRIM(LTRIM(COALESCE(ProviderFax,'')))))),2)),
        L_OECVendorContact_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))),':',RTRIM(LTRIM(COALESCE(VendorID,''))),':',RTRIM(LTRIM(COALESCE(VendorPhone ,''))),':',RTRIM(LTRIM(COALESCE(VendorFax,'')))))),2)),
	   ...
	   L_OECProviderNetwork_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(ClientID, ''))), ':', RTRIM(LTRIM(COALESCE(OECProject_BK, ''))), ':', RTRIM(LTRIM(COALESCE(CentauriNetworkID, ''))), ':', RTRIM(LTRIM(COALESCE(MemberID, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))),':',RTRIM(LTRIM(COALESCE(CentauriProviderID,''))),':',RTRIM(LTRIM(COALESCE(CentauriNetworkID ,'')))))),2))
