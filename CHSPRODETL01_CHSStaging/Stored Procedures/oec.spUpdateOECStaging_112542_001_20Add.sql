...
CREATE PROC [oec].[spUpdateOECStaging_112542_001_20Add]
AS
     SET NOCOUNT ON;
     SET XACT_ABORT ON;
    ...
    UPDATE oec.AdvanceOECRaw_112542_001_20Add 
    SET ProviderPhone = REPLACE(REPLACE(REPLACE(REPLACE(ProviderPhone,'-',''),'(',''),')',''),' ',''),
	   ...
	   --SELECT memberdob, CONVERT(VARCHAR(10),CONVERT(DATE,MemberDOB),112) FROM oec.AdvanceOECRaw_112542_001_20Add
