CREATE TABLE [adv].[tblUserBCStage]
(
...
[IsClient] [bit] NULL CONSTRAINT [DF__tblUserBC__IsCli__46CABBD7] DEFAULT ((0)),
...
GO
ALTER TABLE [adv].[tblUserBCStage] ADD CONSTRAINT [PK_tblUserBCStage] PRIMARY KEY CLUSTERED  ([User_PK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
