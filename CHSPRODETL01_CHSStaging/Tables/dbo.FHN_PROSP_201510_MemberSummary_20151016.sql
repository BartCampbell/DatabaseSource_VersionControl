CREATE TABLE [dbo].[FHN_PROSP_201510_MemberSummary_20151016]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201510_MemberSummary_20151016] ADD CONSTRAINT [PK_FHN_PROSP_201510_MemberSummary_20151016] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
