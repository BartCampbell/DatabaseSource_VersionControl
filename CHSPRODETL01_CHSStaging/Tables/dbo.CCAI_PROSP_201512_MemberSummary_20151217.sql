CREATE TABLE [dbo].[CCAI_PROSP_201512_MemberSummary_20151217]
(
...
[CASE_MANAGER] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[PHO ID] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[CCAI_PROSP_201512_MemberSummary_20151217] ADD CONSTRAINT [PK_CCAI_PROSP_201512_MemberSummary_20151217] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_PCPName] ON [dbo].[CCAI_PROSP_201512_MemberSummary_20151217] ([PCP Name]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
