CREATE TABLE [dbo].[CCAI_PROSP_201504_MemberSummary_20150423]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROSP_201504_MemberSummary_20150423] ADD CONSTRAINT [PK_CCAI_PROSP_201504_MemberSummary_20150423] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
