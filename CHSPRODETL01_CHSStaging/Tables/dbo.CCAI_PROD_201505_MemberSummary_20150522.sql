CREATE TABLE [dbo].[CCAI_PROD_201505_MemberSummary_20150522]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROD_201505_MemberSummary_20150522] ADD CONSTRAINT [PK_CCAI_PROD_201505_MemberSummary_20150522] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
