CREATE TABLE [oec].[AdvanceOECRaw_112542]
(
...
GO
ALTER TABLE [oec].[AdvanceOECRaw_112542] ADD CONSTRAINT [PK_AdvanceOECRaw_112542] PRIMARY KEY CLUSTERED  ([AdvanceOECRawID]) ON [PRIMARY]
GO
