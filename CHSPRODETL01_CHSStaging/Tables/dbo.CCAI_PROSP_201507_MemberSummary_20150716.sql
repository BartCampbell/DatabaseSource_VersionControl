CREATE TABLE [dbo].[CCAI_PROSP_201507_MemberSummary_20150716]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROSP_201507_MemberSummary_20150716] ADD CONSTRAINT [PK_CCAI_PROSP_201507_MemberSummary_20150716] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
