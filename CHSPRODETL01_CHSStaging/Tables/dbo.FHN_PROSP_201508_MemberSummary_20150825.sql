CREATE TABLE [dbo].[FHN_PROSP_201508_MemberSummary_20150825]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201508_MemberSummary_20150825] ADD CONSTRAINT [PK_FHN_PROSP_201508_MemberSummary_20150825] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
