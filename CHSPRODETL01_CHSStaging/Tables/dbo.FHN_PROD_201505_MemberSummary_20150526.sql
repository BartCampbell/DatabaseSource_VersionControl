CREATE TABLE [dbo].[FHN_PROD_201505_MemberSummary_20150526]
(
...
GO
ALTER TABLE [dbo].[FHN_PROD_201505_MemberSummary_20150526] ADD CONSTRAINT [PK_FHN_PROD_201505_MemberSummary_20150526] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
