CREATE TABLE [dbo].[CCAI_2015_pros_03312015]
(
...
GO
ALTER TABLE [dbo].[CCAI_2015_pros_03312015] ADD CONSTRAINT [PK_CCAI_2015_pros_03312015] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
