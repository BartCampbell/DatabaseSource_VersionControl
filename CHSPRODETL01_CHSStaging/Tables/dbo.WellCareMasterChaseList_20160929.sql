CREATE TABLE [dbo].[WellCareMasterChaseList_20160929]
(
...
GO
ALTER TABLE [dbo].[WellCareMasterChaseList_20160929] ADD CONSTRAINT [PK_WellCareMasterChaseList_20160929] PRIMARY KEY CLUSTERED  ([MasterChaseListID]) ON [PRIMARY]
GO
