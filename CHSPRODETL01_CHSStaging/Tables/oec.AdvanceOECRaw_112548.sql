CREATE TABLE [oec].[AdvanceOECRaw_112548]
(
...
GO
ALTER TABLE [oec].[AdvanceOECRaw_112548] ADD CONSTRAINT [PK_AdvanceOECRaw_112548] PRIMARY KEY CLUSTERED  ([AdvanceOECRawID]) ON [PRIMARY]
GO
