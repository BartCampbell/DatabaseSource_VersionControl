...
BEGIN
	...
	--SET @DestinationRootPath = 'D:\ChartNet\PreferredOne\';
	SET @DestinationRootPath = '\\CHSPRODDB05\ChartNet\P1\';
	...
	SET @Extension3 = 'png';
	SET @Extension4 = 'jpg';
	SET @SourcePath = '\\CHSProdDB05\ChartNet\Incoming\P1\';
	--SET @SourcePath = '\\imihealth\IMI.FTP.Storage\Guardian.Angel.FTP\PreferredOne_Charts\';
	--SET @SourcePath = '\\chs-ftp\FTP-Data\ftpGuardianAngel\ToCentauri\Charts_P1\';
	...
	******************************************************/
	...
	EXEC msdb.dbo.sp_send_dbmail 
		...
		@subject = 'Import Chart Images: Unsupported Files: PREF1 ',  
		@body = @tableHTML,  
		@body_format = 'HTML' ;  
