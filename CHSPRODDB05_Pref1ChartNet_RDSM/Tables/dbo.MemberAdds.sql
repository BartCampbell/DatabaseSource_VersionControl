...
GO
ALTER TABLE [dbo].[MemberAdds] ADD CONSTRAINT [PK_MemberAdds] PRIMARY KEY CLUSTERED  ([CustomerMemberID], [ProductLine], [Product]) ON [PRIMARY]
GO
