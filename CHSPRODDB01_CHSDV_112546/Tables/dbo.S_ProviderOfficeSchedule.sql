...
GO
ALTER TABLE [dbo].[S_ProviderOfficeSchedule] ADD CONSTRAINT [PK_S_ProviderOfficeSchedule] PRIMARY KEY CLUSTERED  ([S_ProviderOfficeSchedule_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081711] ON [dbo].[S_ProviderOfficeSchedule] ([HashDiff]) ON [PRIMARY]
GO
