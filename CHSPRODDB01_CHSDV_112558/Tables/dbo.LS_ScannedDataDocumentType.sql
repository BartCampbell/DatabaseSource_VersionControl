...
GO
ALTER TABLE [dbo].[LS_ScannedDataDocumentType] ADD CONSTRAINT [PK_LS_ScannedDataDocumentType] PRIMARY KEY CLUSTERED  ([LS_ScannedDataDocumentType_RK]) ON [PRIMARY]
GO
