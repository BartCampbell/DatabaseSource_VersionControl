...
GO
ALTER TABLE [dbo].[LS_ContactNotesOfficeContactNote] ADD CONSTRAINT [PK_LS_ContactNotesOfficeContactNote] PRIMARY KEY CLUSTERED  ([LS_ContactNotesOfficeContactNote_RK]) ON [PRIMARY]
GO
