...
GO
ALTER TABLE [dbo].[LS_ContactNotesOfficeProject] ADD CONSTRAINT [PK_LS_ContactNotesOfficeProject] PRIMARY KEY CLUSTERED  ([LS_ContactNotesOfficeProject_RK]) ON [PRIMARY]
GO
