...
GO
ALTER TABLE [dbo].[L_ProviderOfficeProviderOfficeSchedule] ADD CONSTRAINT [PK_L_ProviderOfficeProviderOfficeSchedule] PRIMARY KEY CLUSTERED  ([L_ProviderOfficeProviderOfficeSchedule_RK]) ON [PRIMARY]
GO
