CREATE TABLE [dbo].[S_HEDISDetail]
(
[S_HEDISDetailID] [bigint] NOT NULL IDENTITY(1, 1),
[S_HEDISDetail_RK] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[CLIENT_MEMBER_STATUS] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[S_HEDISDetail] ADD CONSTRAINT [PK_S_HEDISDetail] PRIMARY KEY NONCLUSTERED  ([S_HEDISDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_HEDISRK_RecordEndDate_LoadDate] ON [dbo].[S_HEDISDetail] ([H_HEDIS_RK], [RecordEndDate], [LoadDate]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_RecordEndDate_LoadDate] ON [dbo].[S_HEDISDetail] ([RecordEndDate], [LoadDate]) INCLUDE ([H_HEDIS_RK]) ON [PRIMARY]
GO
CREATE UNIQUE CLUSTERED INDEX [IDX_HEDISDetailID] ON [dbo].[S_HEDISDetail] ([S_HEDISDetailID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[S_HEDISDetail] ADD CONSTRAINT [FK_S_HEDISDetail_H_HEDIS] FOREIGN KEY ([H_HEDIS_RK]) REFERENCES [dbo].[H_HEDIS] ([H_HEDIS_RK])
GO
