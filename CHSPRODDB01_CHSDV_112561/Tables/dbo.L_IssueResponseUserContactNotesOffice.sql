...
GO
ALTER TABLE [dbo].[L_IssueResponseUserContactNotesOffice] ADD CONSTRAINT [PK_L_IssueResponseUserContactNotesOffice] PRIMARY KEY CLUSTERED  ([L_IssueResponseUserContactNotesOffice_RK]) ON [PRIMARY]
GO
