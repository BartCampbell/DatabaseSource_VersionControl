...
GO
ALTER TABLE [dbo].[S_ProviderDemo] ADD CONSTRAINT [PK_S_ProviderDemo] PRIMARY KEY CLUSTERED  ([S_ProviderDemo_RK], [LoadDate]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081538] ON [dbo].[S_ProviderDemo] ([HashDiff]) ON [PRIMARY]
GO
