...
GO
ALTER TABLE [dbo].[S_ScannedDataDetail] ADD CONSTRAINT [PK_S_ScannedDataDetail] PRIMARY KEY CLUSTERED  ([S_ScannedDataDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081739] ON [dbo].[S_ScannedDataDetail] ([HashDiff]) ON [PRIMARY]
GO
