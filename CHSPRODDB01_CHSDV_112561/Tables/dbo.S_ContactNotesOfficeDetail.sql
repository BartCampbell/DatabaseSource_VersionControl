...
GO
ALTER TABLE [dbo].[S_ContactNotesOfficeDetail] ADD CONSTRAINT [PK_S_ContactNotesOfficeDetail] PRIMARY KEY CLUSTERED  ([S_ContactNotesOfficeDetail_RK]) ON [PRIMARY]
GO
