...
GO
ALTER TABLE [dbo].[S_MemberChase] ADD CONSTRAINT [PK_S_MemberChase] PRIMARY KEY CLUSTERED  ([S_MemberChase_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-080904] ON [dbo].[S_MemberChase] ([HashDiff]) ON [PRIMARY]
GO
