...
GO
ALTER TABLE [dbo].[S_AdvanceLocationDetail] ADD CONSTRAINT [PK_S_AdvanceLocationDetail] PRIMARY KEY CLUSTERED  ([S_AdvanceLocationDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081253] ON [dbo].[S_AdvanceLocationDetail] ([HashDiff]) ON [PRIMARY]
GO
