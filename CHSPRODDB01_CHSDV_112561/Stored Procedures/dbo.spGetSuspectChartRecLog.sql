...
AS
    ...
    -- Insert statements for procedure here
      ...
      FROM    [dbo].[H_Suspect] h
                INNER JOIN dbo.S_SuspectChartRecLog s ON s.H_Suspect_RK = h.H_Suspect_RK AND s.RecordEndDate IS NULL
                INNER JOIN  L_SuspectUser a ON a.H_Suspect_RK = h.H_Suspect_RK 
				INNER  JOIN dbo.H_User u ON u.H_User_RK = a.H_User_RK AND s.User_PK = u.ClientUserID
