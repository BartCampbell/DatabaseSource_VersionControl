...
GO
ALTER TABLE [dbo].[S_CodedSourceDetail] ADD CONSTRAINT [PK_S_CodedSourceDetail] PRIMARY KEY CLUSTERED  ([S_CodedSourceDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081309] ON [dbo].[S_CodedSourceDetail] ([HashDiff]) ON [PRIMARY]
GO
