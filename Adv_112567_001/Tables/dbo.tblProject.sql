...
GO
ALTER TABLE [dbo].[tblProject] ADD CONSTRAINT [PK_tblProject] PRIMARY KEY CLUSTERED  ([Project_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblProjectClient] ON [dbo].[tblProject] ([Client_PK]) ON [PRIMARY]
GO
