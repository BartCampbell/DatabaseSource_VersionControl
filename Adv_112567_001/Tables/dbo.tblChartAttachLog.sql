...
GO
CREATE NONCLUSTERED INDEX [IX_tblChartAttachLog_1] ON [dbo].[tblChartAttachLog] ([Suspect_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblChartAttachLog] ON [dbo].[tblChartAttachLog] ([User_PK]) ON [PRIMARY]
GO
