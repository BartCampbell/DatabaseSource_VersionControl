...
GO
ALTER TABLE [dbo].[ErrorLog] ADD CONSTRAINT [PK_ErrorLog] PRIMARY KEY CLUSTERED  ([ErrorLogID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[ErrorLog] ADD CONSTRAINT [FK_ErrorLog_ClientProcessInstance] FOREIGN KEY ([LoadInstanceID]) REFERENCES [dbo].[ClientProcessInstance] ([LoadInstanceID])
GO
