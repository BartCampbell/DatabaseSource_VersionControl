CREATE TABLE [dbo].[ScannedDocumentMetadata_Stage]
(
...
GO
ALTER TABLE [dbo].[ScannedDocumentMetadata_Stage] ADD CONSTRAINT [PK_ScannedDocumentMetadata_Stage] PRIMARY KEY CLUSTERED  ([RecID]) ON [PRIMARY]
GO
