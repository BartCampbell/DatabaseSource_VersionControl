...
AS
    ...
    BEGIN TRY
		   ...
		   NPI,
             ...
             RecordSource
               ...
               FROM  @ProviderList AS l
                     LEFT JOIN CHSDV.dbo.R_Provider AS r ON l.ClientProviderID = r.ClientProviderID
             ...
             RecordSource
               ...
               SELECT DISTINCT
				...
				l.NPI,
                    ...
                    l.RecordSource
               FROM  @ProviderList AS l
                     LEFT JOIN CHSDV.dbo.R_Provider AS r ON l.NPI = r.NPI
               WHERE ISNULL(l.NPI,'') <> '' AND r.CentauriProviderID IS NULL;
	   ...
	   SELECT
		   ...
		   r.NPI
        FROM @ProviderList AS l
             INNER JOIN CHSDV.dbo.R_Provider AS r ON l.ClientProviderID = r.ClientProviderID
                                             AND l.ClientID = r.ClientID
	   UNION
	   SELECT
             r.CentauriProviderID,
		   ...
		   r.NPI
        FROM @ProviderList AS l
             INNER JOIN CHSDV.dbo.R_Provider AS r ON l.NPI = r.NPI 
