...
GO
ALTER TABLE [dbo].[S_IssueResponseDetail] ADD CONSTRAINT [PK_S_IssueResponseDetail] PRIMARY KEY CLUSTERED  ([S_IssueResponseDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081427] ON [dbo].[S_IssueResponseDetail] ([HashDiff]) ON [PRIMARY]
GO
