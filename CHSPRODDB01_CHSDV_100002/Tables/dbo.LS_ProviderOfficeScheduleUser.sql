...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeScheduleUser] ADD CONSTRAINT [PK_LS_ProviderOfficeScheduleUser] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeScheduleUser_RK]) ON [PRIMARY]
GO
