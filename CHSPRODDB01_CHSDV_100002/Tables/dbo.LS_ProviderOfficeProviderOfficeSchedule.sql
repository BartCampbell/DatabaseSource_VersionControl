...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeProviderOfficeSchedule] ADD CONSTRAINT [PK_LS_ProviderOfficeProviderOfficeSchedule] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeProviderOfficeSchedule_RK]) ON [PRIMARY]
GO
