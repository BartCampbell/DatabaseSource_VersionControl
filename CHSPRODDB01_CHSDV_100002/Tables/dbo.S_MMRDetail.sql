CREATE TABLE [dbo].[S_MMRDetail]
(
[S_MMRDetail_RK] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[S_MMRDetail] ADD CONSTRAINT [PK_S_MMRDetail] PRIMARY KEY CLUSTERED  ([S_MMRDetail_RK]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[S_MMRDetail] ADD CONSTRAINT [FK_S_MMRDetail_H_MMR] FOREIGN KEY ([H_MMR_RK]) REFERENCES [dbo].[H_MMR] ([H_MMR_RK])
GO
