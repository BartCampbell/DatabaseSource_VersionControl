...
---- Description:	Loads all the Hubs from the Chase List based on dbo.spDV_OEC_LoadHubs
---- Usage:			
----		  EXECUTE dbo.spDV_Lists_LoadHubs
---- =============================================

CREATE PROCEDURE [dbo].[spDV_Lists_LoadHubs]
AS
    BEGIN
        ...
        BEGIN TRY
            ...
            INSERT  INTO dbo.H_Provider
                    ...
                    SELECT DISTINCT
                            ...
                            p.FileName ,
                            p.LoadDate
                    FROM    CHSStaging.oec.AdvanceOECRaw_112547 AS p
            ...
            INSERT  INTO dbo.H_Member
                    ...
                    SELECT DISTINCT
                            ...
                            LoadDate ,
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112547
