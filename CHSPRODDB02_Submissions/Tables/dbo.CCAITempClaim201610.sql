CREATE TABLE [dbo].[CCAITempClaim201610]
(
...
GO
ALTER TABLE [dbo].[CCAITempClaim201610] ADD CONSTRAINT [PK_CCAITempClaim201610] PRIMARY KEY CLUSTERED  ([CCAITempId]) ON [PRIMARY]
GO
