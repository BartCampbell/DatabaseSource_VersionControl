CREATE TABLE [dbo].[RAPSSubmissionStaging]
(
...
[RAPSSubmissionStagingID] [int] NOT NULL IDENTITY(1, 1)
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[RAPSSubmissionStaging] ADD CONSTRAINT [PK_RAPSSubmissionStaging] PRIMARY KEY CLUSTERED  ([RAPSSubmissionStagingID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
