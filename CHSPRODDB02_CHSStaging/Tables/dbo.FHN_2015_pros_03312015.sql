CREATE TABLE [dbo].[FHN_2015_pros_03312015]
(
...
GO
ALTER TABLE [dbo].[FHN_2015_pros_03312015] ADD CONSTRAINT [PK_FHN_2015_pros_03312015] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_Field7] ON [dbo].[FHN_2015_pros_03312015] ([FIELD7]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
