CREATE TABLE [dbo].[FHN_PROSP_201511_MemberSummary_20151123]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201511_MemberSummary_20151123] ADD CONSTRAINT [PK_FHN_PROSP_201511_MemberSummary_20151123] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
