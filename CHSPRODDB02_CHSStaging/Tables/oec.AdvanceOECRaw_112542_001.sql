CREATE TABLE [oec].[AdvanceOECRaw_112542_001]
(
...
GO
ALTER TABLE [oec].[AdvanceOECRaw_112542_001] ADD CONSTRAINT [PK_AdvanceOECRaw_112542_001] PRIMARY KEY CLUSTERED  ([AdvanceOECRawID]) ON [PRIMARY]
GO
