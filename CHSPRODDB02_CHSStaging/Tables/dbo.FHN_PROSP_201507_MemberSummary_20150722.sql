CREATE TABLE [dbo].[FHN_PROSP_201507_MemberSummary_20150722]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201507_MemberSummary_20150722] ADD CONSTRAINT [PK_FHN_PROSP_201507_MemberSummary_20150722] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
