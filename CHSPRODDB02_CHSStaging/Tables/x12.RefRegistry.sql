...
GO
CREATE NONCLUSTERED INDEX [idx_RefRegistry_TransactionImplementationConventionReference] ON [x12].[RefRegistry] ([TransactionImplementationConventionReference]) ON [PRIMARY]
GO
