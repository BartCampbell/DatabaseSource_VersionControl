CREATE TABLE [dbo].[CCAI_PROSP_201506_MemberSummary_20150615]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROSP_201506_MemberSummary_20150615] ADD CONSTRAINT [PK_CCAI_PROSP_201506_MemberSummary_20150615] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
