CREATE TABLE [dbo].[Emblem_ProfessionalClaim_Stage]
(
...
GO
ALTER TABLE [dbo].[Emblem_ProfessionalClaim_Stage] ADD CONSTRAINT [PK_Emblem_ProfessionalClaim_Stage] PRIMARY KEY CLUSTERED  ([CLAIM_ID], [SV_LINE]) ON [PRIMARY]
GO
