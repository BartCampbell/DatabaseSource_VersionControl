CREATE TABLE [dbo].[CCAI_834_MAPD_MASTER]
(
[SubscriberNumber] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[RecordSource] [varchar] (28) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
) ON [PRIMARY]
GO
