...
[IsProcessed] [bit] NULL CONSTRAINT [DF_WellcareApixioFile_Stage_IsProcessed] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[WellcareApixioFile_Stage] ADD CONSTRAINT [PK_WellcareApixioFile_Stage_1] PRIMARY KEY CLUSTERED  ([WellcareApixioFileID]) ON [PRIMARY]
GO
