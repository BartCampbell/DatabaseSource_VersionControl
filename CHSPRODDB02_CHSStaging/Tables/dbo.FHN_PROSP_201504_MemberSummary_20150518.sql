CREATE TABLE [dbo].[FHN_PROSP_201504_MemberSummary_20150518]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201504_MemberSummary_20150518] ADD CONSTRAINT [PK_FHN_PROSP_201504_MemberSummary_20150518] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
