...
AS
    ...
    -- Insert statements for procedure here
            ...
            BEGIN
                INSERT  INTO CHSDV.[dbo].[R_ProviderOffice]
                        ...
                        FROM    CHSStaging.adv.tblProviderOfficeWCStage a
                                LEFT OUTER JOIN CHSDV.[dbo].[R_ProviderOffice] b ON a.ProviderOffice_PK = b.[ClientProviderOfficeID]
                ...
                FROM    CHSStaging.adv.tblProviderOfficeWCStage a
                        INNER JOIN CHSDV.dbo.R_ProviderOffice b ON a.ProviderOffice_PK = b.ClientProviderOfficeID
                                                                   AND a.CCI = b.ClientID;
        ...
        IF @CCI IN ( 112549, 112550, 112546 )
			...
			BEGIN
                INSERT  INTO CHSDV.[dbo].[R_Provider]
                        ...
                        SELECT  DISTINCT
                                ...
                                a.[RecordSource]
                        FROM    CHSStaging.adv.tblProviderMasterStage a
                                LEFT OUTER JOIN CHSDV.[dbo].[R_Provider] b ON CAST(a.Provider_ID AS VARCHAR) = b.NPI OR CAST(a.Provider_ID AS VARCHAR) = b.ClientProviderID
                                                                              AND a.CCI = b.ClientID
                        WHERE   a.CCI = @CCI  AND 
								ISNULL(a.Provider_ID ,'') NOT IN ('','0') AND
								b.[CentauriProviderID] IS NULL;
                ...
                SET     ProviderMasterHashKey = b.ProviderHashKey ,
                        CPI = b.CentauriProviderID
                FROM    CHSStaging.adv.tblProviderMasterStage a
                        INNER JOIN CHSDV.dbo.R_Provider b ON  CAST(a.Provider_ID AS VARCHAR) = b.ClientProviderID
                                                             AND a.CCI = b.ClientID
															 WHERE ISNULL(a.Provider_ID ,'') NOT IN ('','0') AND a.CPI IS NULL;
                ...
                SET     ProviderMasterHashKey = b.ProviderHashKey ,
                        CPI = b.CentauriProviderID
                FROM    CHSStaging.adv.tblProviderMasterStage a
                        INNER JOIN CHSDV.dbo.R_Provider b ON CAST(a.Provider_ID AS VARCHAR) = b.NPI
                                                             AND a.CCI = b.ClientID
															 WHERE ISNULL(a.Provider_ID ,'') NOT IN ('','0') AND a.CPI IS NULL;
			...
			IF @CCI IN (112557,112558,112559,112560,112561)
			BEGIN
                INSERT  INTO CHSDV.[dbo].[R_Provider]
                        ( [ClientID] ,
                          [ClientProviderID] ,
                        ...
                        SELECT  DISTINCT
                               a.[CCI] ,
                                ...
                                a.[RecordSource]
                        FROM    CHSStaging.adv.tblProviderMasterStage a
                                LEFT OUTER JOIN CHSDV.[dbo].[R_Provider] b ON CAST(a.Provider_ID AS VARCHAR) =  b.ClientProviderID
                                                                              AND a.CCI = b.ClientID
                        WHERE   a.CCI = CCI  
						AND 
								b.[CentauriProviderID] IS NULL;
        ...
        FROM    CHSStaging.adv.tblProviderOfficeScheduleStage a
                INNER JOIN CHSDV.dbo.R_ProviderOfficeSchedule b ON a.ProviderOfficeSchedule_PK = b.ClientProviderOfficeScheduleID
                                                                   AND a.CCI = b.ClientID;
