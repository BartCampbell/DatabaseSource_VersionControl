...
CREATE PROC [oec].[spUpdateOECStaging_112542_002]
AS
     SET NOCOUNT ON;
     SET XACT_ABORT ON;
	...
	FROM oec.AdvanceOECRaw_112542_002 s 
	     INNER JOIN CHSDV.dbo.R_OECProject r ON s.ClientID = r.CentauriClientID AND '002' = r.ProjectID


    UPDATE oec.AdvanceOECRaw_112542_002 
    SET ProviderPhone = REPLACE(REPLACE(REPLACE(REPLACE(ProviderPhone,'-',''),'(',''),')',''),' ',''),
	   ...
	   --SELECT memberdob, CONVERT(VARCHAR(10),CONVERT(DATE,MemberDOB),112) FROM oec.AdvanceOECRaw_112542_002
    ...
    SET H_OEC_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(RTRIM(LTRIM(COALESCE(OEC_BK, ''))))), 2)),
	   ...
	   S_OECDetail_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(FileName, ''))), ':', RTRIM(LTRIM(COALESCE(LoadDate, ''))), ':', RTRIM(LTRIM(COALESCE(OEC_BK, ''))), ':', RTRIM(LTRIM(COALESCE(MemberHICN, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty2, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty3, ''))), ':', RTRIM(LTRIM(COALESCE(DiagnosisCode, ''))), ':', RTRIM(LTRIM(COALESCE(DiagnosisCodeOrder, ''))), ':', RTRIM(LTRIM(COALESCE(DxCodesBillTypeCd, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))), ':', RTRIM(LTRIM(COALESCE(ClaimID, ''))), ':', RTRIM(LTRIM(COALESCE(ChaseID, ''))), ':', RTRIM(LTRIM(COALESCE(MedicalRecordID, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary1, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary2, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary3, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary1, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary2, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary3, ''))), ':', RTRIM(LTRIM(COALESCE(MHMD, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeName, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeAddress, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeCity, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeState, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeZip, '')))))), 2)),
	   S_OECDetail_HashDiff = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(OEC_BK, ''))), ':', RTRIM(LTRIM(COALESCE(MemberHICN, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty2, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderSpecialty3, ''))), ':', RTRIM(LTRIM(COALESCE(DiagnosisCode, ''))), ':', RTRIM(LTRIM(COALESCE(DiagnosisCodeOrder, ''))), ':', RTRIM(LTRIM(COALESCE(DxCodesBillTypeCd, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_FromDate, ''))), ':', RTRIM(LTRIM(COALESCE(DOS_ToDate, ''))), ':', RTRIM(LTRIM(COALESCE(ClaimID, ''))), ':', RTRIM(LTRIM(COALESCE(ChaseID, ''))), ':', RTRIM(LTRIM(COALESCE(MedicalRecordID, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary1, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary2, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Primary3, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary1, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary2, ''))), ':', RTRIM(LTRIM(COALESCE(Claim_Category_Secondary3, ''))), ':', RTRIM(LTRIM(COALESCE(MHMD, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeName, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeAddress, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeCity, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeState, ''))), ':', RTRIM(LTRIM(COALESCE(OfficeZip, ''))) ))), 2)),
	   ...
	   S_ProviderDemo_RK = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(FileName, ''))), ':', RTRIM(LTRIM(COALESCE(LoadDate, ''))), ':', RTRIM(LTRIM(COALESCE(CentauriProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderNPI, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderTIN, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderTINName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderFullName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderLastName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderFirstName, '')))))), 2)),
	   S_ProviderDemoHashDiff = UPPER(CONVERT( CHAR(32), HASHBYTES('MD5', UPPER(CONCAT(RTRIM(LTRIM(COALESCE(CentauriProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderID, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderNPI, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderTIN, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderTINName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderFullName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderLastName, ''))), ':', RTRIM(LTRIM(COALESCE(ProviderFirstName, '')))))), 2)),
	   ...
	   S_Vendor_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(FileName, ''))), ':', RTRIM(LTRIM(COALESCE(LoadDate, ''))), ':',RTRIM(LTRIM(COALESCE(VendorName,''))), ':',RTRIM(LTRIM(COALESCE(VendorID,''))), ':',RTRIM(LTRIM(COALESCE(VendorTIN,''))), ':',RTRIM(LTRIM(COALESCE(VendorTINName,'')))))),2)),
	   S_VendorHashDiff = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',UPPER(CONCAT(RTRIM(LTRIM(COALESCE(VendorName,''))), ':',RTRIM(LTRIM(COALESCE(VendorID,''))), ':',RTRIM(LTRIM(COALESCE(VendorTIN,''))), ':',RTRIM(LTRIM(COALESCE(VendorTINName,'')))))),2)),
