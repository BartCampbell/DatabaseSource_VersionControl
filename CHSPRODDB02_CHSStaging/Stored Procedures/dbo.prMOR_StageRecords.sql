...
-- =============================================
CREATE PROCEDURE [dbo].[prMOR_StageRecords]
...
AS
    BEGIN
        ...
        FROM    mor.MOR_Header_Stage;


        UPDATE  mor.MOR_Trailer_Stage
        ...
        UPDATE  mor.MOR_ARecord_Stage
        SET     LS_MOR_ARecord_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                                      UPPER(LTRIM(RTRIM(COALESCE(RecordTypeCode, ''))) + LTRIM(RTRIM(COALESCE(HICN, '')))
        ...
        UPDATE  mor.MOR_BRecord_Stage
        SET     LS_MOR_BRecord_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                                   UPPER(LTRIM(RTRIM(COALESCE(RecordTypeCode, ''))) + LTRIM(RTRIM(COALESCE(HICN, '')))
                                                                         + LTRIM(RTRIM(COALESCE(LastName, ''))) + LTRIM(RTRIM(COALESCE(FirstName, '')))
                                                                         + LTRIM(RTRIM(COALESCE(MI, ''))) + LTRIM(RTRIM(COALESCE(DOB, '')))
                                                                         + LTRIM(RTRIM(COALESCE(Gender, ''))) + LTRIM(RTRIM(COALESCE(SSN, '')))
        ...
        UPDATE  mor.MOR_CRecord_Stage
        SET     LS_MOR_CRecord_RK = UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                                   UPPER(LTRIM(RTRIM(COALESCE(RecordTypeCode, ''))) + LTRIM(RTRIM(COALESCE(HICN, '')))
                                                                         + LTRIM(RTRIM(COALESCE(LastName, ''))) + LTRIM(RTRIM(COALESCE(FirstName, '')))
                                                                         + LTRIM(RTRIM(COALESCE(MI, ''))) + LTRIM(RTRIM(COALESCE(DOB, '')))
                                                                         + LTRIM(RTRIM(COALESCE(Gender, ''))) + LTRIM(RTRIM(COALESCE(SSN, '')))
