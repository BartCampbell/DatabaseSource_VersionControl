...
GO
ALTER TABLE [dbo].[Eligibility] ADD CONSTRAINT [pk_Eligiility] PRIMARY KEY CLUSTERED  ([EligibilityID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idxEligibilityMemberID] ON [dbo].[Eligibility] ([MemberID]) ON [NDX]
GO
CREATE STATISTICS [sp_pk_Eligiility] ON [dbo].[Eligibility] ([EligibilityID])
GO
CREATE STATISTICS [sp_idxEligibilityMemberID] ON [dbo].[Eligibility] ([MemberID])
GO
