...
GO
ALTER TABLE [dbo].[pharmacy] ADD CONSTRAINT [pk_Pharmacy] PRIMARY KEY CLUSTERED  ([PharmacyID]) ON [PRIMARY]
GO
CREATE STATISTICS [sp_pk_Pharmacy] ON [dbo].[pharmacy] ([PharmacyID])
GO
