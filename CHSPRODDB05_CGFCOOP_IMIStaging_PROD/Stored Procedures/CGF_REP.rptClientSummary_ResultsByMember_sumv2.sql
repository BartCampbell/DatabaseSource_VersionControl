...
CREATE PROC [CGF_REP].[rptClientSummary_ResultsByMember_sumv2]
...
SELECT 
	...
	ORDER BY 	mbr.client,
		...
		cm.MeasureMetricDesc
GO
GRANT VIEW DEFINITION ON  [CGF_REP].[rptClientSummary_ResultsByMember_sumv2] TO [db_ViewProcedures]
GO
