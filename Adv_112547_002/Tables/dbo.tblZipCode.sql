...
GO
ALTER TABLE [dbo].[tblZipCode] ADD CONSTRAINT [PK_tblZipCodes_1] PRIMARY KEY CLUSTERED  ([ZipCode_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblZipCodes] ON [dbo].[tblZipCode] ([ZipCode]) ON [PRIMARY]
GO
