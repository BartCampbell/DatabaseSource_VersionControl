...
--Update 10/05/2016 Replacing ReecodEndDate and LoadDate in Links with Link Satellites PJ
-- Description:	Load all Link Tables from the tblUserStage table
-- =============================================
create PROCEDURE [dbo].[spDV_User_LoadLinkstest]
        ...
        INSERT  INTO [dbo].[L_UserAdvanceLocation]
                ...
                SELECT  UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                          UPPER(CONCAT(RTRIM(LTRIM(COALESCE(a.CUI,
                                                              ''))), ':',
                                                              RTRIM(LTRIM(COALESCE(c.CentauriLocationID,
                                                              '')))))), 2)) ,
                        a.UserHashKey ,
                        c.LocationHashKey ,
                        a.LoadDate ,
