...
[LoadDate] [datetime] NULL CONSTRAINT [DF__H_NoteTyp__LoadD__308E3499] DEFAULT (getdate()),
[RecordSource] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[H_NoteType] ADD CONSTRAINT [PK_H_NoteType] PRIMARY KEY CLUSTERED  ([H_NoteType_RK]) ON [PRIMARY]
GO
