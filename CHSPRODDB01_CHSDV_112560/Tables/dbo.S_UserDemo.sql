...
GO
ALTER TABLE [dbo].[S_UserDemo] ADD CONSTRAINT [PK_S_UserDemo] PRIMARY KEY CLUSTERED  ([S_UserDemo_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081941] ON [dbo].[S_UserDemo] ([HashDiff]) ON [PRIMARY]
GO
