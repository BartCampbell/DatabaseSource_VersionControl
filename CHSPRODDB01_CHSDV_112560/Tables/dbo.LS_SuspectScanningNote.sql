...
GO
ALTER TABLE [dbo].[LS_SuspectScanningNote] ADD CONSTRAINT [PK_LS_SuspectScanningNote] PRIMARY KEY CLUSTERED  ([LS_SuspectScanningNote_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081224] ON [dbo].[LS_SuspectScanningNote] ([HashDiff]) ON [PRIMARY]
GO
