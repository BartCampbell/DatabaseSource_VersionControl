CREATE TABLE [dbo].[S_112544_MemberDemo]
(
...
[S_112544_MemberDemo_RK] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[S_112544_MemberDemo] ADD CONSTRAINT [PK__S_112544__1BB71EFA169C2BC6] PRIMARY KEY CLUSTERED  ([S_112544_MemberDemo_RK]) ON [PRIMARY]
GO
