...
BEGIN
	...
	SET @DestinationRootPath = '\\CHSPRODDB05\ChartNet\MNCM\';
	...
	SET @Extension3 = 'png';
	SET @Extension4 = 'jpg';
	SET @SourcePath = '\\CHSProdDB05\ChartNet\Incoming\MNCM\';
	--SET @SourcePath = '\\chs-ftp\FTP-Data\ftpGuardianAngel\ToCentauri\Charts_MNCM\';
