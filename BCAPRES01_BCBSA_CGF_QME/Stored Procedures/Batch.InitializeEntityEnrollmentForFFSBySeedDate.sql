...
-- Description:	Peforms the initial data gathering for calculating continuous enrollment for entities based on Seed Date for Fee-For-Service enrollment.
--				(Date Comparer: DA519C32-8BF8-41DF-B631-68E24A2D4672)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityEnrollmentForFFSBySeedDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'DA519C32-8BF8-41DF-B631-68E24A2D4672') AND
