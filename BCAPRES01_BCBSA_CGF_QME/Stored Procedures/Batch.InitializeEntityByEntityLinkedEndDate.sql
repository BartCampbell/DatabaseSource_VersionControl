...
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEntityLinkedEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '79576130-4627-431B-B60C-148BFD5254F4') AND
...
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityByEntityLinkedEndDate] TO [Processor]
GO
