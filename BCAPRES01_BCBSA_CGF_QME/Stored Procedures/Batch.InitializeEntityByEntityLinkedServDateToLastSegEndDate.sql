...
-- Description:	Initializes entities with a top-ranked criteria based the linked entity's Last Enrollment Segment's Begin and End Date.  
--				(Date Comparer: 5EFDC340-2A0D-48D9-B4D6-9D576178BF19)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEntityLinkedServDateToLastSegEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '5EFDC340-2A0D-48D9-B4D6-9D576178BF19') AND
