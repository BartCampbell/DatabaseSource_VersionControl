...
--				(Date Comparer: 79576130-4627-431B-B60C-148BFD5254F4)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEntityLinkedBeginDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'E603462B-CFDF-481A-A78B-1B8EC227F8EE') AND
...
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityByEntityLinkedBeginDate] TO [Processor]
GO
