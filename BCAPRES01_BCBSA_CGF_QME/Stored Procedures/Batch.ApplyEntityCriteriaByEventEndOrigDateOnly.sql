...
-- Description:	Applies the additional entity criteria based on the original End Date (only) of the originating event.  
--				(Date Comparer: DA2665B9-6359-4249-9EA2-4BF11DADEF23)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventEndOrigDateOnly]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'DA2665B9-6359-4249-9EA2-4BF11DADEF23') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventEndOrigDateOnly] TO [Processor]
GO
