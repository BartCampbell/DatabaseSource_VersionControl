...
-- Description:	Applies the additional entity criteria based on the Begin Date of the originating entity.  
--				(Date Comparer: 069FE196-81D5-4E17-8A8C-7FEB97EA3155)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEntityBeginDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '069FE196-81D5-4E17-8A8C-7FEB97EA3155') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.BeginEnrollSegDays, DATEADD(mm, MEC.BeginEnrollSegMonths, TEB.BeginDate)) AS EnrollSegBeginDate,
				DATEADD(dd, MEC.EndEnrollSegDays, DATEADD(mm, MEC.EndEnrollSegMonths, TEB.BeginDate)) AS EnrollSegEndDate,
				TEB.EntityBaseID,
				DATEADD(dd, MEC.BeginDays, DATEADD(mm, MEC.BeginMonths, TEB.BeginDate)) AS EntityBeginDate,
				MEC.EntityCritID, 
				DATEADD(dd, MEC.EndDays, DATEADD(mm, MEC.EndMonths, TEB.BeginDate)) AS EntityEndDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEntityBeginDate] TO [Processor]
GO
