...
--				(Date Comparer: 735A7BD1-9A92-47DD-ACB7-EA40CFC8E4B6)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventLinkedEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '735A7BD1-9A92-47DD-ACB7-EA40CFC8E4B6') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventLinkedEndDate] TO [Processor]
GO
