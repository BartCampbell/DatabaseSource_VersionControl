...
-- Description:	Initializes entities with a top-ranked criteria based the linked entity's Original End Date (or Original Begin Date when missing).  
--				(Date Comparer: 5E3E167F-EE4E-458A-A0D3-12A6C115B150)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEntityLinkedEndOrigDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '5E3E167F-EE4E-458A-A0D3-12A6C115B150') AND
