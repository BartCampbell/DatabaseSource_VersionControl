...
-- Description:	Applies the additional entity criteria based on the original Begin Date of the originating entity.  
--				(Date Comparer: 95547B50-05E2-4954-A0DB-8D94E174941B)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEntityBeginOrigDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '95547B50-05E2-4954-A0DB-8D94E174941B') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.BeginEnrollSegDays, DATEADD(mm, MEC.BeginEnrollSegMonths, TEB.BeginOrigDate)) AS EnrollSegBeginDate,
				DATEADD(dd, MEC.EndEnrollSegDays, DATEADD(mm, MEC.EndEnrollSegMonths, TEB.BeginOrigDate)) AS EnrollSegEndDate,
				TEB.EntityBaseID,
				DATEADD(dd, MEC.BeginDays, DATEADD(mm, MEC.BeginMonths, TEB.BeginOrigDate)) AS EntityBeginDate,
				MEC.EntityCritID, 
				DATEADD(dd, MEC.EndDays, DATEADD(mm, MEC.EndMonths, TEB.BeginOrigDate)) AS EntityEndDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEntityBeginOrigDate] TO [Processor]
GO
