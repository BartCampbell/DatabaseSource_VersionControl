...
-- Description:	Applies the additional entity criteria based on Date of Service of the originating event.  
--				(Date Comparer: 222D34D0-FB11-4B73-8BEF-D2175C305354)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventServDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '222D34D0-FB11-4B73-8BEF-D2175C305354') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventServDate] TO [Processor]
GO
