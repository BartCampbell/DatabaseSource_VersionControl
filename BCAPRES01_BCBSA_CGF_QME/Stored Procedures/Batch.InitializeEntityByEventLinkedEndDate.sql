...
-- Description:	Initializes entities with a top-ranked criteria based the linked entity's End Date (or Begin Date when missing).  
--				(Date Comparer: 05AFC2DB-7A80-4270-AF0E-06BA38C21614)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEventLinkedEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '05AFC2DB-7A80-4270-AF0E-06BA38C21614') AND
...
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityByEventLinkedEndDate] TO [Processor]
GO
