...
--				(Date Comparer: ABB54C69-93B3-46AC-959F-45BFA3C5247D)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEventLinkedLastSegBeginDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'ABB54C69-93B3-46AC-959F-45BFA3C5247D') AND
...
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityByEventLinkedLastSegBeginDate] TO [Processor]
GO
