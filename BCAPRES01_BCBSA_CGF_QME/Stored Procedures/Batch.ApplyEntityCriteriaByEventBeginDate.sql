...
-- Description:	Applies the additional entity criteria based on Begin Date of the originating event.  
--				(Date Comparer: 89A33699-1C6E-48F9-AE99-6244DF1D6E70)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventBeginDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '89A33699-1C6E-48F9-AE99-6244DF1D6E70') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventBeginDate] TO [Processor]
GO
