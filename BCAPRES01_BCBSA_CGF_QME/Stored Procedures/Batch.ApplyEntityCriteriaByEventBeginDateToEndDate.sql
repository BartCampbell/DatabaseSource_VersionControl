...
-- Description:	Applies the additional entity criteria between Begin Date on End Date (only) of the originating event.  
--				(Date Comparer: DC09BE77-A6FE-4B2D-9BDB-6082715A2428)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventBeginDateToEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'DC09BE77-A6FE-4B2D-9BDB-6082715A2428') AND
