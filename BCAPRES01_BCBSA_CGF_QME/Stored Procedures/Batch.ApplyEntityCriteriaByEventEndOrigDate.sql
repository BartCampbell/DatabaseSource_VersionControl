...
-- Description:	Applies the additional entity criteria based on the original End Date (or Begin Date, when End Date is missing) of the originating event.  
--				(Date Comparer: 725F6B7E-17D5-4000-A58C-52F5DFC35956)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventEndOrigDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '725F6B7E-17D5-4000-A58C-52F5DFC35956') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				MEC.EntityCritID, 
				ISNULL(TEB.EndOrigDate, TEB.BeginOrigDate) AS EntityDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventEndOrigDate] TO [Processor]
GO
