...
-- Description:	Applies the additional entity criteria based on the End Date (or Begin Date, when End Date is missing) of the originating entity.  
--				(Date Comparer: 502B6820-E59B-4871-A606-5205D11EF437)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEntityEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '502B6820-E59B-4871-A606-5205D11EF437') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.BeginEnrollSegDays, DATEADD(mm, MEC.BeginEnrollSegMonths, ISNULL(TEB.EndDate, TEB.BeginDate))) AS EnrollSegBeginDate,
				DATEADD(dd, MEC.EndEnrollSegDays, DATEADD(mm, MEC.EndEnrollSegMonths, ISNULL(TEB.EndDate, TEB.BeginDate))) AS EnrollSegEndDate,
				TEB.EntityBaseID,
				DATEADD(dd, MEC.BeginDays, DATEADD(mm, MEC.BeginMonths, ISNULL(TEB.EndDate, TEB.BeginDate))) AS EntityBeginDate,
				MEC.EntityCritID, 
				DATEADD(dd, MEC.EndDays, DATEADD(mm, MEC.EndMonths, ISNULL(TEB.EndDate, TEB.BeginDate))) AS EntityEndDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEntityEndDate] TO [Processor]
GO
