...
--				(Date Comparer: D7612542-71D5-4E97-88A0-A9C0623202B7)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEntityLinkedBeginDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'D7612542-71D5-4E97-88A0-A9C0623202B7') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.BeginEnrollSegDays, DATEADD(mm, MEC.BeginEnrollSegMonths, TE.BeginDate)) AS EnrollSegBeginDate,
				DATEADD(dd, MEC.EndEnrollSegDays, DATEADD(mm, MEC.EndEnrollSegMonths, TE.BeginDate)) AS EnrollSegEndDate,
				TEB.EntityBaseID,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEntityLinkedBeginDate] TO [Processor]
GO
