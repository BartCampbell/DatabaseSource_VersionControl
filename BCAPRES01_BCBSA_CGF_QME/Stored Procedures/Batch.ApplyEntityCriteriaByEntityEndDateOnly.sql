...
-- Description:	Applies the additional entity criteria based on the End Date (only) of the originating entity.  
--				(Date Comparer: 4CFFB9C7-5C16-470A-8CCB-C7F37F3C2010)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEntityEndDateOnly]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '4CFFB9C7-5C16-470A-8CCB-C7F37F3C2010') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEntityEndDateOnly] TO [Processor]
GO
