...
--				(Date Comparer: 446F80BD-3800-4003-935B-1EA88D37CD4A)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventSeedDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '446F80BD-3800-4003-935B-1EA88D37CD4A') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				MEC.EntityCritID,
				@BeginInitSeedDate AS EntityDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventSeedDate] TO [Processor]
GO
