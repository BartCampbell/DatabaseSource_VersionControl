...
--				(Date Comparer: 9E4A9961-9323-4BEB-8C20-7C7FF0FFF253)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityByEntityLinkedBeginDateToEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '9E4A9961-9323-4BEB-8C20-7C7FF0FFF253') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.EndEnrollSegDays, ISNULL(TE.EndDate, DATEADD(mm, MEC.EndEnrollSegMonths, TE.BeginDate))) AS EnrollSegEndDate,
...
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityByEntityLinkedBeginDateToEndDate] TO [Processor]
GO
