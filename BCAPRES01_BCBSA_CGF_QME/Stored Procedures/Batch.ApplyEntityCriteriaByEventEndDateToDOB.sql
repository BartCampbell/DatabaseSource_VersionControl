...
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventEndDateToDOB]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'c971d4b9-ca47-4d77-baf1-c5554f67f670') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				DATEADD(dd, MEC.EndDays, DATEADD(mm, MEC.EndMonths, M.DOB)) AS EntityEndDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventEndDateToDOB] TO [Processor]
GO
