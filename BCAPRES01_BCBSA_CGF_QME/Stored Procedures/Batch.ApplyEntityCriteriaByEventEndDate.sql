...
-- Description:	Applies the additional entity criteria based on End Date (or Begin Date, when End Date is missing) of the originating event.  
--				(Date Comparer: C9D69076-2E64-4CD0-9D36-538D64D6DAF4)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'C9D69076-2E64-4CD0-9D36-538D64D6DAF4') AND
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventEndDate] TO [Processor]
GO
