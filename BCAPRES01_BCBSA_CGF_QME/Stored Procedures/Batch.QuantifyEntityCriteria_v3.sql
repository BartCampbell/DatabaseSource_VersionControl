...
-- Description:	Determines the actual quantities for entity criteria. (v3)
-- =============================================
CREATE PROCEDURE [Batch].[QuantifyEntityCriteria_v3]
(
	@BatchID int,
	...
	BEGIN TRY;
		...
		IF @BatchID IS NOT NULL AND	@Iteration IS NOT NULL AND EXISTS (SELECT TOP 1 1 FROM Proxy.EntityBase)
			BEGIN;
				...
				CREATE CLUSTERED INDEX IX_#QtyLookupV1Of2 ON #QtyLookupV1Of2 (DSMemberID, DateComparerInfo, DateCompTypeID, RowID);
				...
				CREATE CLUSTERED INDEX IX_#QtyLookupV2Of2 ON #QtyLookupV2Of2 (DSMemberID, DateComparerInfo, DateCompTypeID, RowID);
				...
				CREATE CLUSTERED INDEX IX_#QtyLookupE1Of1 ON #QtyLookupE1Of1 (DSMemberID, DateComparerInfo, DateCompTypeID, RowID);
