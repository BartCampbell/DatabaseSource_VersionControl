...
-- Description:	Applies the additional entity criteria based on the original Begin Date of the originating event.  
--				(Date Comparer: B977771C-7B36-4E2B-AEBE-EF9B28849382)
-- =============================================
CREATE PROCEDURE [Batch].[ApplyEntityCriteriaByEventBeginOrigDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = 'B977771C-7B36-4E2B-AEBE-EF9B28849382') AND
		...
		SELECT	DATEADD(dd, MEC.AfterDOBDays, DATEADD(mm, MEC.AfterDOBMonths, M.DOB)) AS AfterDOBDate,
				...
				MEC.EntityCritID, 
				TEB.BeginOrigDate AS EntityDate,
...
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventBeginOrigDate] TO [Processor]
GO
