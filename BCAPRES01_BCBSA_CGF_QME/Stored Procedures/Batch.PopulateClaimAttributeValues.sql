...
BEGIN
	...
	BEGIN TRY;
		...
		BEGIN TRY;
			...
			DECLARE @BitClaimAttribLAB bigint;
			...
			SET		BitClaimAttribs = t.BitClaimAttribs,
					IsLab = CASE WHEN CS.ClaimTypeID = @ClaimTypeE AND CS.CodeTypeID IN (@ICD9DiagCodeType, @ICD10DiagCodeType) AND t.BitClaimAttribs & @BitClaimAttribLAB = @BitClaimAttribLAB THEN 1 ELSE CS.IsLab END
