...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Internal_Enrollment] ON [Internal].[Enrollment] ([SpId], [DSMemberID], [BeginDate], [EndDate], [EnrollGroupID]) INCLUDE ([BatchID], [DataRunID], [DataSetID], [Priority]) ON [PRIMARY]
GO
