...
BEGIN
	...
	UPDATE	t
	SET		MeasureID = COALESCE(MX.MeasureID, MX2.MeasureID),
			MetricID = ISNULL(MX.MetricID, t.MetricID)
	FROM	Ncqa.[PLD_FileLayouts] AS t
			...
			LEFT OUTER JOIN Measure.Metrics AS MX2
					ON MX2.MetricID = t.MetricID
