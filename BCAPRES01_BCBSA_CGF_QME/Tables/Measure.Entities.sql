...
[CollapseDays] [smallint] NULL,
[CollapseMonths] [smallint] NULL,
...
GO
ALTER TABLE [Measure].[Entities] ADD CONSTRAINT [CK_Entities_Collapse] CHECK (([CollapseDays]>=(0) AND [CollapseMonths]>=(0) AND ([CollapseDays]>(0) OR [CollapseMonths]>(0)) OR [CollapseDays] IS NULL AND [CollapseMonths] IS NULL))
GO
