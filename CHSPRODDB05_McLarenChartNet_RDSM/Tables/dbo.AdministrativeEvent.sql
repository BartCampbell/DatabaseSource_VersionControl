...
GO
GRANT INSERT ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\George.Graves]
GO
GRANT DELETE ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\George.Graves]
GO
GRANT UPDATE ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\George.Graves]
GO
GRANT INSERT ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\Latisha.Fernandez]
GO
GRANT DELETE ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\Latisha.Fernandez]
GO
GRANT UPDATE ON  [dbo].[AdministrativeEvent] TO [IMIHEALTH\Latisha.Fernandez]
GO
