...
GO
ALTER TABLE [dbo].[LS_IssueResponseOfficeDetail] ADD CONSTRAINT [PK_LS_IssueResponseOfficeDetail] PRIMARY KEY CLUSTERED  ([LS_IssueResponseOfficeDetail_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161004-151325] ON [dbo].[LS_IssueResponseOfficeDetail] ([HashDiff]) ON [PRIMARY]
GO
