...
GO
ALTER TABLE [dbo].[Member] ADD CONSTRAINT [PK_Member] PRIMARY KEY CLUSTERED  ([CustomerMemberID], [ProductLine], [Product]) ON [PRIMARY]
GO
GRANT INSERT ON  [dbo].[Member] TO [IMIHEALTH\George.Graves]
GO
GRANT DELETE ON  [dbo].[Member] TO [IMIHEALTH\George.Graves]
GO
GRANT UPDATE ON  [dbo].[Member] TO [IMIHEALTH\George.Graves]
GO
GRANT INSERT ON  [dbo].[Member] TO [IMIHEALTH\Latisha.Fernandez]
GO
GRANT DELETE ON  [dbo].[Member] TO [IMIHEALTH\Latisha.Fernandez]
GO
GRANT UPDATE ON  [dbo].[Member] TO [IMIHEALTH\Latisha.Fernandez]
GO
