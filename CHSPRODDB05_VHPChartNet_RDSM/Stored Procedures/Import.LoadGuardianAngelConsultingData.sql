...
BEGIN
	...
	CREATE SYNONYM Import.ProviderSite FOR Import.ProviderSite_20170227;
	CREATE SYNONYM Import.PursuitEvent FOR Import.PursuitEvent_20170227;
	*/
	...
	UPDATE dbo.PursuitEvent SET ProductLine = 'Commercial', Product = 'MCCOM' WHERE Product = 'HMO - VHP COMMERCIAL';
	UPDATE dbo.PursuitEvent SET ProductLine = 'Marketplace', Product = 'CovCal_ON' WHERE Product LIKE 'MMO - VHP On Exchange';
