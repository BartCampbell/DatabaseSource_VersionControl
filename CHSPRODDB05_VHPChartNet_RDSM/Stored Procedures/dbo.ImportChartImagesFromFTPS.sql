...
BEGIN
	...
	SET @DestinationRootPath = '\\CHSPRODDB05\ChartNet\VHP\';
	...
	SET @Extension3 = 'png';
	SET @Extension4 = 'jpg';
	SET @SourcePath = '\\CHSProdDB05\ChartNet\Incoming\VHP\';
	--SET @SourcePath = '\\chs-ftp\FTP-Data\ftpGuardianAngel\ToCentauri\Charts_VHP\';
	...
	******************************************************/
	...
	EXEC msdb.dbo.sp_send_dbmail 
		...
		@subject = 'Import Chart Images: Unsupported Files: VHP ',  
		@body = @tableHTML,  
		@body_format = 'HTML' ;  
