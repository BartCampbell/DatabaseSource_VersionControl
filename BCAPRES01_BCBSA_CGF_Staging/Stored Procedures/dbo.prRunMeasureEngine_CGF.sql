...
--/*
CREATE PROC [dbo].[prRunMeasureEngine_CGF]
...
SET @cmd = 'EXEC	' + @EngineDB + '.Cloud.InitializeDataRun ' + CHAR(13)
		+ '@BatchSize = ' + CONVERT(VARCHAR(10),@BatchSize) + ', ' + CHAR(13)
		+ '@BeginInitSeedDate = ''' + CONVERT(VARCHAR(8),@BeginInitSeedDate,112) + ''', '  + CHAR(13)
