...
BEGIN 
    ...
    INSERT INTO BCBSA_CGF_Staging.dbo.Provider (
        ...
        SELECT
				...
				RowID = p.RowID,
				SpecialtyCode1 = NULL,--CASE WHEN spec.PrimarySpecialty = 1 THEN spec.ProviderSpecialtyID ELSE '' END,
				SpecialtyCode2 = NULL,--CASE WHEN spec.PrimarySpecialty = 0 THEN spec.ProviderSpecialtyID ELSE '' END,
					SSN = NULL,
					TaxID = NULL,
					UPIN = NULL,
