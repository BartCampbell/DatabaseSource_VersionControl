CREATE TABLE [dbo].[FHN_2016_Pros_05192015_NoHeadersMapped]
(
...
GO
ALTER TABLE [dbo].[FHN_2016_Pros_05192015_NoHeadersMapped] ADD CONSTRAINT [PK_FHN_2016_Pros_05192015] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
