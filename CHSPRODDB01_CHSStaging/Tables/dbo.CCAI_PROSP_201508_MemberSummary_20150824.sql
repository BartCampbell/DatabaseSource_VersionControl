CREATE TABLE [dbo].[CCAI_PROSP_201508_MemberSummary_20150824]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROSP_201508_MemberSummary_20150824] ADD CONSTRAINT [PK_CCAI_PROSP_201508_MemberSummary_20150824] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
