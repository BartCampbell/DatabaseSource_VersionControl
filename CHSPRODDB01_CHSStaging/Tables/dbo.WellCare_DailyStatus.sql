...
[DocumentPageCount] [int] NULL CONSTRAINT [DF__WellCare___Docum__576C034B] DEFAULT ((0)),
...
[IssueFlag] [int] NULL CONSTRAINT [DF__WellCare___Issue__58602784] DEFAULT ((0)),
[LoadDate] [date] NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
ALTER TABLE [dbo].[WellCare_DailyStatus] ADD CONSTRAINT [UQ__WellCare__360414FE77B427B6] UNIQUE NONCLUSTERED  ([RecID]) ON [PRIMARY]
GO
