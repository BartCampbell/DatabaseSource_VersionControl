CREATE TABLE [dbo].[FHN_PROD_201504_MemberSummary_20150409]
(
...
GO
ALTER TABLE [dbo].[FHN_PROD_201504_MemberSummary_20150409] ADD CONSTRAINT [PK_fhn_PROD_201504_MemberSummary_20150409] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
