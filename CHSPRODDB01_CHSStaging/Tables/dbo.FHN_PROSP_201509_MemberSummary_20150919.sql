CREATE TABLE [dbo].[FHN_PROSP_201509_MemberSummary_20150919]
(
...
GO
ALTER TABLE [dbo].[FHN_PROSP_201509_MemberSummary_20150919] ADD CONSTRAINT [PK_FHN_PROSP_201509_MemberSummary_20150919] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
