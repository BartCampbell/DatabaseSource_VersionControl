CREATE TABLE [dbo].[WellCare_2ND_CHART_CHASE_20161010]
(
[Chart ID] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[WellCare_2ND_CHART_CHASE_20161010] ADD CONSTRAINT [PK_WellCare_2ND_CHART_CHASE_20161010] PRIMARY KEY CLUSTERED  ([Chart ID]) ON [PRIMARY]
GO
