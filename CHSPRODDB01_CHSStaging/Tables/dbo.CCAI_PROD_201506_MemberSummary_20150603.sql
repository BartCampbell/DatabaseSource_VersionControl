CREATE TABLE [dbo].[CCAI_PROD_201506_MemberSummary_20150603]
(
...
GO
ALTER TABLE [dbo].[CCAI_PROD_201506_MemberSummary_20150603] ADD CONSTRAINT [PK_CCAI_PROD_201506_MemberSummary_20150603] PRIMARY KEY CLUSTERED  ([RecID]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
