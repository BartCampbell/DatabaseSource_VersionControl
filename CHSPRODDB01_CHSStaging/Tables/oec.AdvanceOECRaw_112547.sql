CREATE TABLE [oec].[AdvanceOECRaw_112547]
(
...
GO
ALTER TABLE [oec].[AdvanceOECRaw_112547] ADD CONSTRAINT [PK_AdvanceOECRaw_112547] PRIMARY KEY CLUSTERED  ([AdvanceOECRawID]) ON [PRIMARY]
GO
