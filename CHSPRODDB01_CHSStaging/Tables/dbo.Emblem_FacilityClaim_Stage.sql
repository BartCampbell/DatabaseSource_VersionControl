CREATE TABLE [dbo].[Emblem_FacilityClaim_Stage]
(
...
GO
ALTER TABLE [dbo].[Emblem_FacilityClaim_Stage] ADD CONSTRAINT [PK_Emblem_FacilityClaim_Stage] PRIMARY KEY CLUSTERED  ([CLAIM_ID], [SV_LINE]) ON [PRIMARY]
GO
