CREATE TABLE [dbo].[CCAI_834_DSNP_20151001]
(
...
GO
ALTER TABLE [dbo].[CCAI_834_DSNP_20151001] ADD CONSTRAINT [PK_CCAI_834_DSNP_20151001] PRIMARY KEY CLUSTERED  ([SubscriberNumber]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
