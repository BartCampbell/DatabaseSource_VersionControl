CREATE TABLE [oec].[AdvanceOECRaw_112549]
(
...
GO
ALTER TABLE [oec].[AdvanceOECRaw_112549] ADD CONSTRAINT [PK_AdvanceOECRaw_112549] PRIMARY KEY CLUSTERED  ([AdvanceOECRawID]) ON [PRIMARY]
GO
