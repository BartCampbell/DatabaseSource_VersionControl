CREATE TABLE [dbo].[WPS_WPSDrug_20150805]
(
...
[POS_Description] [varchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_MemberID] ON [dbo].[WPS_WPSDrug_20150805] ([Member_ID]) INCLUDE ([NDC], [NDC_Description]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_NDC] ON [dbo].[WPS_WPSDrug_20150805] ([NDC]) INCLUDE ([Member_ID], [NDC_Description]) ON [PRIMARY]
GO
