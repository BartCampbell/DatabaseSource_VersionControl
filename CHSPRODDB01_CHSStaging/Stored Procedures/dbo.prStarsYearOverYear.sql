...
-- =============================================
CREATE PROCEDURE [dbo].[prStarsYearOverYear] 
...
set ANSI_Warnings OFF;
    ...
    select [Star Rating Year],
		 ...
		 [Measurement Period Open/Closed/Future],[Domain],[Measure ID],[Star Measure Name],[Part_C_D_Display_Measure],[Weighted Star], [Part C Summary Weighting]
