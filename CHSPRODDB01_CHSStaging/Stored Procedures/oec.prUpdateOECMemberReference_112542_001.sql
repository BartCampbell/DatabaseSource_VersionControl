...
-- Create date:	19/17/2016
-- Description:	Loads new members into the member reference table from the OEC staging tables
-- Usage:			
--		  EXECUTE oec.prUpdateOECMemberReference_112542_001
-- =============================================

CREATE PROCEDURE [oec].[prUpdateOECMemberReference_112542_001]
AS
    BEGIN
...
--SELECT * FROM oec.AdvanceOECRaw_112542_001
