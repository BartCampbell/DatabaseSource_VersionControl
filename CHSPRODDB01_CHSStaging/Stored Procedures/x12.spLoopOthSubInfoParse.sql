...
BEGIN
	...
	SELECT
		...
		-- 2320 - SBR
		,h.b.value('(SBR/SBR01/text())[1]', 'varchar(50)') AS 'OthSubInfo_PayerResponsibilitySequenceNumberCode_SBR01'
		,h.b.value('(SBR/SBR02/text())[1]', 'varchar(50)') AS 'OthSubInfo_IndividualRelationshipCode_SBR02'
		,h.b.value('(SBR/SBR03/text())[1]', 'varchar(50)') AS 'OthSubInfo_ReferenceIdentification_SBR03'
		,h.b.value('(SBR/SBR04/text())[1]', 'varchar(50)') AS 'OthSubInfo_Name_SBR04'
		,h.b.value('(SBR/SBR05/text())[1]', 'varchar(50)') AS 'OthSubInfo_InsuranceTypeCode_SBR05'
		,h.b.value('(SBR/SBR06/text())[1]', 'varchar(50)') AS 'OthSubInfo_CoordinationOfBenefitsCode_SBR06'
		,h.b.value('(SBR/SBR07/text())[1]', 'varchar(50)') AS 'OthSubInfo_YesNoConditionOrResponseCode_SBR07'
		,h.b.value('(SBR/SBR08/text())[1]', 'varchar(50)') AS 'OthSubInfo_EmploymentStatusCode_SBR08'
		,h.b.value('(SBR/SBR09/text())[1]', 'varchar(50)') AS 'OthSubInfo_ClaimFilingIndicatorCode_SBR09'
		...
		,h.b.value('(OI/OI01/text())[1]', 'varchar(50)') AS 'OthSubInfo_ClaimFilingIndicatorCode_OI01'
		,h.b.value('(OI/OI02/text())[1]', 'varchar(50)') AS 'OthSubInfo_ClaimSubmissionReasonCode_OI02'
		,h.b.value('(OI/OI03/text())[1]', 'varchar(50)') AS 'OthSubInfo_YesNoConditionOrResponseCode_OI03'
		,h.b.value('(OI/OI04/text())[1]', 'varchar(50)') AS 'OthSubInfo_PatientSignatureSourceCode_OI04'
		,h.b.value('(OI/OI05/text())[1]', 'varchar(50)') AS 'OthSubInfo_ProviderAgreementCode_OI05'
		,h.b.value('(OI/OI06/text())[1]', 'varchar(50)') AS 'OthSubInfo_ReleaseofInformationCode_OI06'
		-- 2320 - MIA
		,h.b.value('(MIA/MIA01/text())[1]', 'varchar(50)') AS 'OthSubInfo_Quantity_MIA01'
		,h.b.value('(MIA/MIA02/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA02'
		,h.b.value('(MIA/MIA03/text())[1]', 'varchar(50)') AS 'OthSubInfo_Quantity_MIA03'
		,h.b.value('(MIA/MIA04/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA04'
		,h.b.value('(MIA/MIA05/text())[1]', 'varchar(50)') AS 'OthSubInfo_ReferenceIdentification_MIA05'
		,h.b.value('(MIA/MIA06/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA06'
		,h.b.value('(MIA/MIA07/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA07'
		,h.b.value('(MIA/MIA08/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA08'
		,h.b.value('(MIA/MIA09/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA09'
		,h.b.value('(MIA/MIA10/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA10'
		,h.b.value('(MIA/MIA11/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA11'
		,h.b.value('(MIA/MIA12/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA12'
		,h.b.value('(MIA/MIA13/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA13'
		,h.b.value('(MIA/MIA14/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA14'
		,h.b.value('(MIA/MIA15/text())[1]', 'varchar(50)') AS 'OthSubInfo_Quantity_MIA15'
		,h.b.value('(MIA/MIA16/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA16'
		,h.b.value('(MIA/MIA17/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA17'
		,h.b.value('(MIA/MIA18/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA18'
		,h.b.value('(MIA/MIA19/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA19'
		...
		,h.b.value('(MIA/MIA24/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MIA24'
		-- OthSubInfo - MOA
		,h.b.value('(MOA/MOA01/text())[1]', 'varchar(50)') AS 'OthSubInfo_PercentageAsDecimal_MOA01'
		,h.b.value('(MOA/MOA02/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MOA02'
		...
		,h.b.value('(MOA/MOA08/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MOA08'
		,h.b.value('(MOA/MOA09/text())[1]', 'varchar(50)') AS 'OthSubInfo_MonetaryAmount_MOA09'
	FROM 
		x12.shred x
	OUTER APPLY 
	...
	SELECT
		...
		,h.b.value('(CAS01/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentGroupCode_CAS01'
		,h.b.value('(CAS02/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS02'
		,h.b.value('(CAS03/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS03'
		,h.b.value('(CAS04/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS04'
		,h.b.value('(CAS05/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS05'
		,h.b.value('(CAS06/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS06'
		,h.b.value('(CAS07/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS07'
		,h.b.value('(CAS08/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS08'
		,h.b.value('(CAS09/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS09'
		,h.b.value('(CAS10/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS10'
		,h.b.value('(CAS11/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS11'
		,h.b.value('(CAS12/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS12'
		,h.b.value('(CAS13/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS13'
		,h.b.value('(CAS14/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS14'
		,h.b.value('(CAS15/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS15'
		,h.b.value('(CAS16/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS16'
		,h.b.value('(CAS17/text())[1]', 'varchar(50)') AS 'CAS_ClaimAdjustmentReasonCode_CAS17'
		,h.b.value('(CAS18/text())[1]', 'varchar(50)') AS 'CAS_MonetaryAmount_CAS18'
		,h.b.value('(CAS19/text())[1]', 'varchar(50)') AS 'CAS_Quantity_CAS19'
	FROM 
		x12.shred x
	CROSS APPLY 
