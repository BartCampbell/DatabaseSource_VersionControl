...
INSERT INTO x12.LoopSvcLnAdj (
	...
	SELECT
		...
		,h.b.value('(SVD/SVD01/text())[1]', 'varchar(50)') AS 'SvcLnAdj_IdentificationCode_SVD01'
		,h.b.value('(SVD/SVD02/text())[1]', 'varchar(50)') AS 'SvcLnAdj_MonetaryAmount_SVD02'
		-- SvcLnAdj - 2430 - SVD/SVD03
		,h.b.value('(SVD/SVD03/SVD0301/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProductServiceIDQualifier_SVD0301'
		,h.b.value('(SVD/SVD03/SVD0302/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProductServiceID_SVD0302'
		,h.b.value('(SVD/SVD03/SVD0303/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProcedureModifier_SVD0303'
		,h.b.value('(SVD/SVD03/SVD0304/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProcedureModifier_SVD0304'
		,h.b.value('(SVD/SVD03/SVD0305/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProcedureModifier_SVD0305'
		,h.b.value('(SVD/SVD03/SVD0306/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProcedureModifier_SVD0306'
		,h.b.value('(SVD/SVD03/SVD0307/text())[1]', 'varchar(50)') AS 'SvcLnAdj_Description_SVD0307'
		,h.b.value('(SVD/SVD03/SVD0308/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProductServiceID_SVD0308'
		,h.b.value('(SVD/SVD04/text())[1]', 'varchar(50)') AS 'SvcLnAdj_ProductServiceID_SVD04'
		,h.b.value('(SVD/SVD05/text())[1]', 'varchar(50)') AS 'SvcLnAdj_Quantity_SVD05'
		,h.b.value('(SVD/SVD06/text())[1]', 'varchar(50)') AS 'SvcLnAdj_AssignedNumber_SVD06'
	FROM 
		x12.shred x
	OUTER APPLY 
