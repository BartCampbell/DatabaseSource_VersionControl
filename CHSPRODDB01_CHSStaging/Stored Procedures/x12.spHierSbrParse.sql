...
BEGIN
	...
	SELECT
		...
		,h.b.value('(HL/HL01/text())[1]', 'varchar(50)') AS 'HeirSubsciber_HierarchicalIDNumber_HL01'
		,h.b.value('(HL/HL02/text())[1]', 'varchar(50)') AS 'HeirSubsciber_HierarchicalParentIDNumber_HL02'
		,h.b.value('(HL/HL03/text())[1]', 'varchar(50)') AS 'HeirSubsciber_HierarchicalLevelCode_HL03'
		,h.b.value('(HL/HL04/text())[1]', 'varchar(50)') AS 'HeirSubsciber_HierarchicalChildCode_HL04'
		-- 2000B - SBR - Subscriber Information
		,h.b.value('(SBR/SBR01/text())[1]', 'varchar(50)') AS 'HeirSubsciber_PayerResponsibilitySequenceNumberCode_SBR01'
		,h.b.value('(SBR/SBR02/text())[1]', 'varchar(50)') AS 'HeirSubsciber_IndividualRelationshipCode_SBR02'
		,h.b.value('(SBR/SBR03/text())[1]', 'varchar(50)') AS 'HeirSubsciber_ReferenceIdentification_SBR03'
		,h.b.value('(SBR/SBR04/text())[1]', 'varchar(50)') AS 'HeirSubsciber_Name_SBR04'
		,h.b.value('(SBR/SBR05/text())[1]', 'varchar(50)') AS 'HeirSubsciber_InsuranceTypeCode_SBR05'
		,h.b.value('(SBR/SBR06/text())[1]', 'varchar(50)') AS 'HeirSubsciber_CoordinationOfBenefitsCode_SBR06'
		,h.b.value('(SBR/SBR07/text())[1]', 'varchar(50)') AS 'HeirSubsciber_YesNoConditionOrResponseCode_SBR07'
		,h.b.value('(SBR/SBR08/text())[1]', 'varchar(50)') AS 'HeirSubsciber_EmploymentStatusCode_SBR08'
		,h.b.value('(SBR/SBR09/text())[1]', 'varchar(50)') AS 'HeirSubsciber_ClaimFilingIndicatorCode_SBR09'
		-- 2000B - PAT- PATIENT INFORMATION
		,h.b.value('(PAT/PAT01/text())[1]', 'varchar(50)') AS 'HeirSubsciber_IndividualRelationshipCode_PAT01'
		,h.b.value('(PAT/PAT02/text())[1]', 'varchar(50)') AS 'HeirSubsciber_PatientLocationCode_PAT02'
		,h.b.value('(PAT/PAT03/text())[1]', 'varchar(50)') AS 'HeirSubsciber_EmploymentStatusCode_PAT03'
		,h.b.value('(PAT/PAT04/text())[1]', 'varchar(50)') AS 'HeirSubsciber_StudentStatusCode_PAT04'
		,h.b.value('(PAT/PAT05/text())[1]', 'varchar(50)') AS 'HeirSubsciber_DateTimePeriodFormatQualifier_PAT05'
		,h.b.value('(PAT/PAT06/text())[1]', 'varchar(50)') AS 'HeirSubsciber_DateImePeriod_PAT06'
		,h.b.value('(PAT/PAT07/text())[1]', 'varchar(50)') AS 'HeirSubsciber_UnitOrBasisForMeasurementCode_PAT07'
		,h.b.value('(PAT/PAT08/text())[1]', 'varchar(50)') AS 'HeirSubsciber_Weight_PAT08'
		,h.b.value('(PAT/PAT09/text())[1]', 'varchar(50)') AS 'HeirSubsciber_YesNoConditionOrResponseCode_PAT09'
	FROM 
		x12.shred x
	OUTER APPLY 
