...
BEGIN
	...
	SELECT
		...
		,h.b.value('(HL/HL01/text())[1]', 'varchar(50)') AS 'HierPat_HierarchicalIDNumber_HL01'
		,h.b.value('(HL/HL02/text())[1]', 'varchar(50)') AS 'HierPat_HierarchicalParentIDNumber_HL02'
		,h.b.value('(HL/HL03/text())[1]', 'varchar(50)') AS 'HierPat_HierarchicalLevelCode_HL03'
		,h.b.value('(HL/HL04/text())[1]', 'varchar(50)') AS 'HierPat_HierarchicalChildCode_HL04'
		-- 2000C - PAT- PATIENT INFORMATION
		,h.b.value('(PAT/PAT01/text())[1]', 'varchar(50)') AS 'HierPat_IndividualRelationshipCode_PAT01'
		,h.b.value('(PAT/PAT02/text())[1]', 'varchar(50)') AS 'HierPat_PatientLocationCode_PAT02'
		,h.b.value('(PAT/PAT03/text())[1]', 'varchar(50)') AS 'HierPat_EmploymentStatusCode_PAT03'
		,h.b.value('(PAT/PAT04/text())[1]', 'varchar(50)') AS 'HierPat_StudentStatusCode_PAT04'
		,h.b.value('(PAT/PAT05/text())[1]', 'varchar(50)') AS 'HierPat_DateTimePeriodFormatQualifier_PAT05'
		,h.b.value('(PAT/PAT06/text())[1]', 'varchar(50)') AS 'HierPat_DateTimePeriod_PAT06'
		,h.b.value('(PAT/PAT07/text())[1]', 'varchar(50)') AS 'HierPat_UnitOrBasisforMeasurementCode_PAT07'
		,h.b.value('(PAT/PAT08/text())[1]', 'varchar(50)') AS 'HierPat_Weight_PAT08'
		,h.b.value('(PAT/PAT09/text())[1]', 'varchar(50)') AS 'HierPat_Yes/NoConditionOrResponseCode_PAT09'
	FROM 
		x12.shred x
	OUTER APPLY 
