...
GO
ALTER TABLE [ref].[NPI_Master] ADD CONSTRAINT [PK__NPI_Mast__C7DE9A13813FF7A1] PRIMARY KEY CLUSTERED  ([NPI]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_NPI_Master_17_951674438__K1_21_22] ON [ref].[NPI_Master] ([NPI]) INCLUDE ([Provider First Line Business Mailing Address], [Provider Second Line Business Mailing Address]) ON [PRIMARY]
GO
