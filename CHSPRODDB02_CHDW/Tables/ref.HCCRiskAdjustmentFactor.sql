CREATE TABLE [ref].[HCCRiskAdjustmentFactor]
(
[HCCVersion] [int] NULL,
...
[HCCRiskAdjustmentFactorID] [int] NOT NULL
) ON [PRIMARY]
GO
ALTER TABLE [ref].[HCCRiskAdjustmentFactor] ADD CONSTRAINT [PK_HCCRiskAdjustmentFactor] PRIMARY KEY CLUSTERED  ([HCCRiskAdjustmentFactorID]) ON [PRIMARY]
GO
