CREATE TABLE [dbo].[Emblem_Accordion_ProfessionalClaimExtract]
(
...
GO
ALTER TABLE [dbo].[Emblem_Accordion_ProfessionalClaimExtract] ADD CONSTRAINT [PK_Emblem_Accordion_ProfessionalClaimExtract] PRIMARY KEY CLUSTERED  ([RecordID]) ON [PRIMARY]
GO
