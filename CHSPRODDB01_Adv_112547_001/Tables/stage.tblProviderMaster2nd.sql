CREATE TABLE [stage].[tblProviderMaster2nd]
(
...
GO
ALTER TABLE [stage].[tblProviderMaster2nd] ADD CONSTRAINT [PK_tblProviderMaster] PRIMARY KEY CLUSTERED  ([ProviderMaster_PK]) ON [PRIMARY]
GO
