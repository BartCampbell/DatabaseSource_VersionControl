...
GO
CREATE NONCLUSTERED INDEX [_dta_index_tblSuspect_37_1120723045__K38_K4_K37_K1_K2] ON [dbo].[tblSuspect] ([ChaseStatus_PK], [Suspect_PK], [Channel_PK], [Project_PK], [Provider_PK]) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [_dta_index_tblSuspect_37_1120723045__K1_K37_4] ON [dbo].[tblSuspect] ([Project_PK], [Channel_PK]) INCLUDE ([Suspect_PK]) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [_dta_index_tblSuspect_37_1120723045__K1_K2_K37_4_5_6] ON [dbo].[tblSuspect] ([Project_PK], [Provider_PK], [Channel_PK]) INCLUDE ([IsCNA], [IsScanned], [Suspect_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [_dta_index_tblSuspect_37_1120723045__K1_K4_K38_K37] ON [dbo].[tblSuspect] ([Project_PK], [Suspect_PK], [ChaseStatus_PK], [Channel_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_tblSuspectProvider] ON [dbo].[tblSuspect] ([Provider_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [_dta_index_tblSuspect_37_1120723045__K2_K3] ON [dbo].[tblSuspect] ([Provider_PK], [Member_PK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_SuspectPK_ScanDate] ON [dbo].[tblSuspect] ([Suspect_PK]) INCLUDE ([Scanned_Date]) ON [PRIMARY]
GO
CREATE STATISTICS [_dta_stat_1120723045_37_1_38] ON [dbo].[tblSuspect] ([Channel_PK], [Project_PK], [ChaseStatus_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_37_1_38_4] ON [dbo].[tblSuspect] ([Channel_PK], [Project_PK], [ChaseStatus_PK], [Suspect_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_37_4] ON [dbo].[tblSuspect] ([Channel_PK], [Suspect_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_38_37] ON [dbo].[tblSuspect] ([ChaseStatus_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_1_37_4_2_38] ON [dbo].[tblSuspect] ([Project_PK], [Channel_PK], [Suspect_PK], [Provider_PK], [ChaseStatus_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_1_38_37] ON [dbo].[tblSuspect] ([Project_PK], [ChaseStatus_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_1_4_37] ON [dbo].[tblSuspect] ([Project_PK], [Suspect_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_2_37] ON [dbo].[tblSuspect] ([Provider_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_2_1_37] ON [dbo].[tblSuspect] ([Provider_PK], [Project_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_4_37] ON [dbo].[tblSuspect] ([Suspect_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_4_38_37] ON [dbo].[tblSuspect] ([Suspect_PK], [ChaseStatus_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_4_1_38_37] ON [dbo].[tblSuspect] ([Suspect_PK], [Project_PK], [ChaseStatus_PK], [Channel_PK])
GO
CREATE STATISTICS [_dta_stat_1120723045_4_2_37] ON [dbo].[tblSuspect] ([Suspect_PK], [Provider_PK], [Channel_PK])
GO
