CREATE TABLE [stage].[tblProviderOffice2nd]
(
...
GO
ALTER TABLE [stage].[tblProviderOffice2nd] ADD CONSTRAINT [PK_tblProviderOffice] PRIMARY KEY CLUSTERED  ([ProviderOffice_PK]) ON [PRIMARY]
GO
