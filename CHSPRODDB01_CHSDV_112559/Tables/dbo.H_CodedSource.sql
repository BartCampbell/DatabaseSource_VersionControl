...
[LoadDate] [datetime] NULL CONSTRAINT [DF__H_CodedSo__LoadD__2057CCD0] DEFAULT (getdate()),
[RecordSource] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[H_CodedSource] ADD CONSTRAINT [PK_H_CodedSource] PRIMARY KEY CLUSTERED  ([H_CodedSource_RK]) ON [PRIMARY]
GO
