CREATE TABLE [ChartNetImport].[MemberMeasureSample]
(
...
GO
ALTER TABLE [ChartNetImport].[MemberMeasureSample] ADD CONSTRAINT [PK_MemberMeasureSample_1] PRIMARY KEY CLUSTERED  ([CustomerMemberID], [HEDISMeasure], [EventDate]) ON [PRIMARY]
GO
