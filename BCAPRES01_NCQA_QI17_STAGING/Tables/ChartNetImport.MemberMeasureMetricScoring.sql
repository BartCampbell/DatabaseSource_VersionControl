CREATE TABLE [ChartNetImport].[MemberMeasureMetricScoring]
(
...
GO
ALTER TABLE [ChartNetImport].[MemberMeasureMetricScoring] ADD CONSTRAINT [PK_MemberMeasureMetricScoring_1] PRIMARY KEY CLUSTERED  ([CustomerMemberID], [HEDISMeasure], [EventDate], [HEDISSubMetric]) ON [PRIMARY]
GO
