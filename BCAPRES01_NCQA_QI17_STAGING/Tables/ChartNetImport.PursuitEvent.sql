CREATE TABLE [ChartNetImport].[PursuitEvent]
(
...
GO
ALTER TABLE [ChartNetImport].[PursuitEvent] ADD CONSTRAINT [PK_PursuitEvent] PRIMARY KEY CLUSTERED  ([PursuitEventTrackingNumber], [HEDISMeasure], [EventDate]) ON [PRIMARY]
GO
