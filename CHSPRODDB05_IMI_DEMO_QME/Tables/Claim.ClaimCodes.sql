...
GO
CREATE NONCLUSTERED INDEX [IX_Claim_ClaimCodes_Codes] ON [Claim].[ClaimCodes] ([Code], [CodeTypeID]) ON [IDX3]
GO
CREATE NONCLUSTERED INDEX [IX_Claim_ClaimCodes] ON [Claim].[ClaimCodes] ([DataSetID], [DSClaimLineID]) INCLUDE ([ClaimTypeID], [Code], [CodeTypeID], [DSClaimCodeID], [DSClaimID], [IsPrimary]) ON [IDX3]
GO
CREATE NONCLUSTERED INDEX [IX_Claim_ClaimCodes_DSClaimLineID] ON [Claim].[ClaimCodes] ([DSClaimLineID]) ON [IDX3]
GO
