CREATE TABLE [Result].[MeasureDetail_HPC]
(
...
[Qty] [int] NOT NULL,
[ResultRowGuid] [uniqueidentifier] NOT NULL CONSTRAINT [DF_MeasureDetail_HPC_ResultRowGuid] DEFAULT (newid()),
[ResultRowID] [bigint] NOT NULL IDENTITY(1, 1),
[SourceRowGuid] [uniqueidentifier] NOT NULL,
[SourceRowID] [bigint] NOT NULL CONSTRAINT [DF_MeasureDetail_HPC_SourceRowID] DEFAULT ((-1))
) ON [PRIMARY]
GO
ALTER TABLE [Result].[MeasureDetail_HPC] ADD CONSTRAINT [PK_Result_MeasureDetail_HPC] PRIMARY KEY CLUSTERED  ([ResultRowID]) ON [PRIMARY]
GO
