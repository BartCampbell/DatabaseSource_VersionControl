...
-- Description:	Peforms the initial data gathering for calculating continuous enrollment for entities based on End Date only for Fee-For-Service enrollment.
--				(Date Comparer: 477E409A-D1B9-4784-9608-B33AE039E05F)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityEnrollmentForFFSByEndDateOnly]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '477E409A-D1B9-4784-9608-B33AE039E05F') AND
		...
		SELECT DISTINCT
				TEB.BeginDate, EEK.BenefitID, TEB.DSMemberID, TEB.EndDate, TEB.EntityBaseID, 
...
GO
GRANT VIEW DEFINITION ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDateOnly] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDateOnly] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDateOnly] TO [Processor]
GO
