...
-- Description:	Retrieves the default population for the specified datarun.
-- =============================================
CREATE PROCEDURE [Report].[GetPopulationDefault]
(
	@DataRunID int
)
AS
...
GO
GRANT EXECUTE ON  [Report].[GetPopulationDefault] TO [Reports]
GO
