...
-- Description:	Identifies the earliest possible entity episode per member by "End Date" (or "Begin Date" when missing).
--				(Entity Type: 3F5242A0-C2E7-4081-975C-9A884EFA6D05)
-- =============================================
CREATE PROCEDURE [Batch].[IdentifyEntityEpisodesForEarliestByEndDate]
(
	@BatchID int,
					...
					FROM	Measure.Entities AS ME
							...
							INNER JOIN Measure.EntityTypes AS MET
									ON ME.EntityTypeID = MET.EntityTypeID AND
										...
										MET.EntityTypeGuid = '3F5242A0-C2E7-4081-975C-9A884EFA6D05'	
				)
...
GO
GRANT VIEW DEFINITION ON  [Batch].[IdentifyEntityEpisodesForEarliestByEndDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[IdentifyEntityEpisodesForEarliestByEndDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[IdentifyEntityEpisodesForEarliestByEndDate] TO [Processor]
GO
