...
-- Description:	Retrieves the top-level measure/metric based summary comparison report.
-- =============================================
CREATE PROCEDURE [Report].[GetMeasureSummaryComparison]
(
	@FromDataRunID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		SET @LogObjectName = 'GetMeasureSummaryComparison'; 
...
GO
GRANT EXECUTE ON  [Report].[GetMeasureSummaryComparison] TO [Reports]
GO
