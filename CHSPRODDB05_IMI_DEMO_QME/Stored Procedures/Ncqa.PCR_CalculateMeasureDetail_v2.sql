...
--				(Unpaid Version:  Originally made with ProductLineID, not BitProductLines)
-- =============================================
CREATE PROCEDURE [Ncqa].[PCR_CalculateMeasureDetail_v2]
(
	@BatchID int = NULL,
	...
	BEGIN TRY;
		...
		BEGIN TRY;
			...
			FROM	Product.Payers AS PP
					...
					INNER JOIN Ncqa.PCR_ProductLineWeights_v1 AS NPPLW
							ON PPL.ProductLineID = NPPLW.ProductLineID
