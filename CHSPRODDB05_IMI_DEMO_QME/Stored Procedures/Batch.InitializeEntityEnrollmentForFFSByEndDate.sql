...
-- Description:	Peforms the initial data gathering for calculating continuous enrollment for entities based on End Date (or Begin Date when missing) for Fee-For-Service enrollment.
--				(Date Comparer: 56D6290A-C2D4-41A4-9E57-3493805ED00F)
-- =============================================
CREATE PROCEDURE [Batch].[InitializeEntityEnrollmentForFFSByEndDate]
(
	@BatchID int,
...
BEGIN
	...
	BEGIN TRY;
		...
		WHERE	(DateComparerGuid = '56D6290A-C2D4-41A4-9E57-3493805ED00F') AND
...
GO
GRANT VIEW DEFINITION ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[InitializeEntityEnrollmentForFFSByEndDate] TO [Processor]
GO
