...
-- Description:	Determines the actual quantities for entity criteria. (v2)
-- =============================================
CREATE PROCEDURE [Batch].[QuantifyEntityCriteria_v2]
(
	@BatchID int,
	...
	BEGIN TRY;
		...
		IF @BatchID IS NOT NULL AND	@Iteration IS NOT NULL AND EXISTS (SELECT TOP 1 1 FROM Proxy.EntityBase)
			BEGIN;
				...
				CREATE CLUSTERED INDEX IX_#QtyLookup2 ON #QtyLookup (DSMemberID, DateComparerInfo, DateCompTypeID, RowID);
				...
				CREATE UNIQUE CLUSTERED INDEX IX_#Events ON #Events (DSMemberID, EventID, DSEventID);
...
GO
GRANT VIEW DEFINITION ON  [Batch].[QuantifyEntityCriteria_v2] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[QuantifyEntityCriteria_v2] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[QuantifyEntityCriteria_v2] TO [Processor]
GO
