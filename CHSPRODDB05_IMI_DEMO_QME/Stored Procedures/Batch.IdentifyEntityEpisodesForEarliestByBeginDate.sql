...
-- Description:	Identifies the earliest possible entity episode per member by "Begin Date".
--				(Entity Type: 58A1ECD4-9FEB-45E1-9F53-1E41F05ED3E6)
-- =============================================
CREATE PROCEDURE [Batch].[IdentifyEntityEpisodesForEarliestByBeginDate]
(
	@BatchID int,
					...
					FROM	Measure.Entities AS ME
							...
							INNER JOIN Measure.EntityTypes AS MET
									ON ME.EntityTypeID = MET.EntityTypeID AND
										...
										MET.EntityTypeGuid = '58A1ECD4-9FEB-45E1-9F53-1E41F05ED3E6'	
				)
...
GO
GRANT VIEW DEFINITION ON  [Batch].[IdentifyEntityEpisodesForEarliestByBeginDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[IdentifyEntityEpisodesForEarliestByBeginDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[IdentifyEntityEpisodesForEarliestByBeginDate] TO [Processor]
GO
