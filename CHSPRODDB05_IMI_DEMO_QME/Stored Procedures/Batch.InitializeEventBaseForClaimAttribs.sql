...
GO
GRANT VIEW DEFINITION ON  [Batch].[InitializeEventBaseForClaimAttribs] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[InitializeEventBaseForClaimAttribs] TO [db_executer]
GO
