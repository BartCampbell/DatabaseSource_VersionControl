...
GO
GRANT VIEW DEFINITION ON  [Batch].[ApplyEntityCriteriaByEventEndDateOnly] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventEndDateOnly] TO [db_executer]
GO
