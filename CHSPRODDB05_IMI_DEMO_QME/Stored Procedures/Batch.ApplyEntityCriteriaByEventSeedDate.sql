...
GO
GRANT VIEW DEFINITION ON  [Batch].[ApplyEntityCriteriaByEventSeedDate] TO [db_executer]
GO
GRANT EXECUTE ON  [Batch].[ApplyEntityCriteriaByEventSeedDate] TO [db_executer]
GO
