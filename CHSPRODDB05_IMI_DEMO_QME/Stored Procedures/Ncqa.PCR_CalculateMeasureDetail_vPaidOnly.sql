...
-- =============================================
CREATE PROCEDURE [Ncqa].[PCR_CalculateMeasureDetail_vPaidOnly]
(
	@BatchID int = NULL,
...
BEGIN
	...
	BEGIN TRY;
		...
		SET @LogObjectName = 'PCR_CalculateMeasureDetail_vPaidOnly'; 
			...
			IF EXISTS (SELECT TOP 1 1 FROM #PCR_Base)
				BEGIN;
					...
					SELECT	CAST(NULL AS decimal(18,12)) AS AdjProbability,
							...
							CAST(NULL AS decimal(18,12)) AS DccWeight1,
							CAST(NULL AS decimal(18,12)) AS DccWeight2,
							CAST(NULL AS decimal(18,12)) AS DccWeight3,
							CAST(NULL AS decimal(18,12)) AS DccWeight4,
					...
					SET		DccWeight = ISNULL(CCW.[Weight], 0),
							DccWeight1 = ISNULL(CCW.[Weight], 0),
							DccWeight2 = 0,
							DccWeight3 = 0,
							DccWeight4 = 0
					FROM	#Weights AS W
