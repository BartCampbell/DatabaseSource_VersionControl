...
[LoadDate] [datetime] NULL CONSTRAINT [DF__H_Scanned__LoadD__3DE82FB7] DEFAULT (getdate()),
[RecordSource] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[H_ScannedData] ADD CONSTRAINT [PK_H_ScannedData] PRIMARY KEY CLUSTERED  ([H_ScannedData_RK]) ON [PRIMARY]
GO
