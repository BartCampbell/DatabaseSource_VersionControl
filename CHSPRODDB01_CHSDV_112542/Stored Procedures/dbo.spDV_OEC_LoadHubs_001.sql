...
---- Usage:			
----		  EXECUTE dbo.spDV_OEC_LoadHubs_001
---- =============================================

CREATE PROCEDURE [dbo].[spDV_OEC_LoadHubs_001]
AS
    BEGIN
        ...
        BEGIN TRY
            ...
            INSERT  INTO dbo.H_Provider
                    ...
                    SELECT DISTINCT
                            ...
                            p.FileName ,
                            p.LoadDate
                    FROM    CHSStaging.oec.AdvanceOECRaw_112542_001 AS p
            ...
            INSERT  INTO dbo.H_Member
                    ...
                    SELECT DISTINCT
                            ...
                            LoadDate ,
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112542_001
