...
-- Usage:			
--		  EXECUTE dbo.spDV_OEC_LoadSats_002
-- =============================================

CREATE PROCEDURE [dbo].[spDV_OEC_LoadSats_002]
AS
    BEGIN
        ...
        BEGIN TRY
				  ...
				  Fax,
                    ...
                    SELECT DISTINCT
					   ...
					   o.ProviderFax,
                            ...
                            o.FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112542_002 o
		  ...
		  --LOAD OECDetail satellite
            INSERT  INTO dbo.S_OECDetail
				  ...
				  ProviderSpecialty2, 
				  ProviderSpecialty3,
				  Claim_Category_Primary1,
				  Claim_Category_Primary2,
				  Claim_Category_Primary3,
				  Claim_Category_Secondary1,
				  Claim_Category_Secondary2,
				  Claim_Category_Secondary3,
				  MHMD,
				  OfficeName,
				  OfficeAddress,
				  OfficeCity,
				  ...
				  OfficeZip,
                    ...
                    SELECT DISTINCT
					   ...
					   o.ChaseID ,
					   o.ProviderSpecialty,
					   o.ProviderSpecialty2,
					   o.ProviderSpecialty3,
					   o.Claim_Category_Primary1,
					   o.Claim_Category_Primary2,
					   o.Claim_Category_Primary3,
					   o.Claim_Category_Secondary1,
					   o.Claim_Category_Secondary2,
					   o.Claim_Category_Secondary3,
					   o.MHMD,
					   o.OfficeName,
					   o.OfficeAddress,
					   o.OfficeCity,
