...
AS
    ...
    SELECT  DISTINCT
		  ...
		  s.MedicalRecordID,
		  s.ProviderSpecialty,
		  s.ProviderSpecialty2,
		  s.ProviderSpecialty3,
		  s.PricingID,
		  s.SVCTaxID,
		  s.MHFacilityFlag,
		  s.NetworkIndicator,
		  s.Claim_Category_Primary1,
		  s.Claim_Category_Primary2,
		  s.Claim_Category_Primary3,
		  s.Claim_Category_Secondary1,
		  s.Claim_Category_Secondary2,
		  s.Claim_Category_Secondary3,
		  s.MHMD,
		  s.OfficeName,
		  s.OfficeAddress,
		  s.OfficeCity,
