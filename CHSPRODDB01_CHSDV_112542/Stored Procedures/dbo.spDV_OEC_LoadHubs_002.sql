...
---- Usage:			
----		  EXECUTE dbo.spDV_OEC_LoadHubs_002
---- =============================================

CREATE PROCEDURE [dbo].[spDV_OEC_LoadHubs_002]
AS
    BEGIN
        ...
        BEGIN TRY
            ...
            INSERT  INTO dbo.H_Provider
                    ...
                    SELECT DISTINCT
                            ...
                            p.FileName ,
                            p.LoadDate
                    FROM    CHSStaging.oec.AdvanceOECRaw_112542_002 AS p
            ...
            INSERT  INTO dbo.H_Member
                    ...
                    SELECT DISTINCT
                            ...
                            LoadDate ,
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112542_002
