...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeLocation] ADD CONSTRAINT [PK_LS_ProviderOfficeLocation] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeLocation_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
