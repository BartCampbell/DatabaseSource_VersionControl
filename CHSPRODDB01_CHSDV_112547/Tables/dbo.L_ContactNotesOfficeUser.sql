...
GO
ALTER TABLE [dbo].[L_ContactNotesOfficeUser] ADD CONSTRAINT [PK_L_ContactNotesOfficeUser] PRIMARY KEY CLUSTERED  ([L_ContactNotesOfficeUser_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
