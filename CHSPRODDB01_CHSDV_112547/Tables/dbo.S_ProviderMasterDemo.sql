...
GO
ALTER TABLE [dbo].[S_ProviderMasterDemo] ADD CONSTRAINT [PK_S_ProviderMasterDemo] PRIMARY KEY CLUSTERED  ([S_ProviderMasterDemo_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
