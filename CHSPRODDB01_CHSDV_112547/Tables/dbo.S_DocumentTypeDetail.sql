...
GO
ALTER TABLE [dbo].[S_DocumentTypeDetail] ADD CONSTRAINT [PK_S_DocumentTypeDetail] PRIMARY KEY CLUSTERED  ([S_DocumentTypeDetail_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081353] ON [dbo].[S_DocumentTypeDetail] ([HashDiff]) ON [PRIMARY]
GO
