...
GO
ALTER TABLE [dbo].[S_SuspectDOS] ADD CONSTRAINT [PK_S_SuspectDOS] PRIMARY KEY CLUSTERED  ([S_SuspectDOS_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161003-081915] ON [dbo].[S_SuspectDOS] ([HashDiff]) ON [PRIMARY]
GO
