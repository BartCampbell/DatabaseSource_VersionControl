...
GO
ALTER TABLE [dbo].[LS_ContactNotesOfficeProvider] ADD CONSTRAINT [PK_LS_ContactNotesOfficeProvider] PRIMARY KEY CLUSTERED  ([LS_ContactNotesOfficeProvider_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
