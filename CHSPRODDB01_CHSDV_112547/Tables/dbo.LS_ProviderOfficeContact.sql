...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeContact] ADD CONSTRAINT [PK_LS_ProviderOfficeContact] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeContact_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
