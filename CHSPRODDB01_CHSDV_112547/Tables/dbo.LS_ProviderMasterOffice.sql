...
GO
ALTER TABLE [dbo].[LS_ProviderMasterOffice] ADD CONSTRAINT [PK_LS_ProviderMasterOffice] PRIMARY KEY CLUSTERED  ([LS_ProviderMasterOffice_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-20161025-111014] ON [dbo].[LS_ProviderMasterOffice] ([HashDiff]) ON [PRIMARY]
GO
