...
GO
ALTER TABLE [dbo].[L_ExtractionQueueUser] ADD CONSTRAINT [PK_L_ExtractionQueueUser] PRIMARY KEY CLUSTERED  ([L_ExtractionQueueUser_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
