...
(
[S_RAPS_Response_BBBID] [bigint] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [dbo].[S_RAPS_Response_BBB] ADD CONSTRAINT [PK_S_RAPS_Response_BBB] PRIMARY KEY CLUSTERED  ([S_RAPS_Response_BBBID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_EndDate] ON [dbo].[S_RAPS_Response_BBB] ([RecordEndDate]) INCLUDE ([H_RAPS_Response_RK], [HashDiff], [S_RAPS_Response_BBB_RK]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_S_RAPS_Response_BBB] ON [dbo].[S_RAPS_Response_BBB] ([S_RAPS_Response_BBB_RK]) ON [PRIMARY]
GO
