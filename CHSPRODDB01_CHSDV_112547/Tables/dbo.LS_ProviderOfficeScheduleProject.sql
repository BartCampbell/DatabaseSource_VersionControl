...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeScheduleProject] ADD CONSTRAINT [PK_LS_ProviderOfficeScheduleProject] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeScheduleProject_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
