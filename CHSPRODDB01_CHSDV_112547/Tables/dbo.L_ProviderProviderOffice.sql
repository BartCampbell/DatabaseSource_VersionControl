...
GO
ALTER TABLE [dbo].[L_ProviderProviderOffice] ADD CONSTRAINT [PK_L_ProviderProviderOffice] PRIMARY KEY CLUSTERED  ([L_ProviderProviderOffice_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
