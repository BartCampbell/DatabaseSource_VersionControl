...
GO
ALTER TABLE [dbo].[L_ContactNotesOfficeProvider] ADD CONSTRAINT [PK_L_ContactNotesOfficeProvider] PRIMARY KEY CLUSTERED  ([L_ContactNotesOfficeProvider_RK]) ON [PRIMARY]
GO
