...
GO
ALTER TABLE [dbo].[LS_ProviderOfficeScheduleScheduleType] ADD CONSTRAINT [PK_LS_ProviderOfficeScheduleScheduleType] PRIMARY KEY CLUSTERED  ([LS_ProviderOfficeScheduleScheduleType_RK]) ON [PRIMARY]
GO
