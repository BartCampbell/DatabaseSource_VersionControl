...
GO
ALTER TABLE [dbo].[L_ProviderOfficeContact] ADD CONSTRAINT [PK_L_ProviderOfficeContact] PRIMARY KEY CLUSTERED  ([L_ProviderOfficeContact_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
