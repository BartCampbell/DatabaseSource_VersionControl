...
GO
ALTER TABLE [dbo].[L_ContactNotesOfficeContactNote] ADD CONSTRAINT [PK_L_ContactNotesOfficeContactNote] PRIMARY KEY CLUSTERED  ([L_ContactNotesOfficeContactNote_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
