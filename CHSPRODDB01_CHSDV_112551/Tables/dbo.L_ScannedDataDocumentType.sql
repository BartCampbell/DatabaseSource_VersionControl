...
GO
ALTER TABLE [dbo].[L_ScannedDataDocumentType] ADD CONSTRAINT [PK_L_ScannedDataDocumentType] PRIMARY KEY CLUSTERED  ([L_ScannedDataDocumentType_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
