...
GO
ALTER TABLE [dbo].[S_ScheduleTypeDetail] ADD CONSTRAINT [PK_S_ScheduleTypeDetail] PRIMARY KEY CLUSTERED  ([S_ScheduleTypeDetail_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
