...
GO
ALTER TABLE [dbo].[L_ContactNotesOfficeProject] ADD CONSTRAINT [PK_L_ContactNotesOfficeProject] PRIMARY KEY CLUSTERED  ([L_ContactNotesOfficeProject_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
