...
GO
ALTER TABLE [dbo].[L_ProviderOfficeScheduleScheduleType] ADD CONSTRAINT [PK_L_ProviderOfficeScheduleScheduleType] PRIMARY KEY CLUSTERED  ([L_ProviderOfficeScheduleScheduleType_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
