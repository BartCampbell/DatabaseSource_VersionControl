...
GO
ALTER TABLE [dbo].[S_SuspectChartRecLog] ADD CONSTRAINT [PK_S_SuspectChartRecLog] PRIMARY KEY CLUSTERED  ([S_SuspectChartRecLog_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
