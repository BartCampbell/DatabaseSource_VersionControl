...
[LoadDate] [datetime] NULL CONSTRAINT [DF__H_Schedul__LoadD__5F141958] DEFAULT (getdate()),
[RecordSource] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[H_ScheduleType] ADD CONSTRAINT [PK_H_ScheduleType] PRIMARY KEY CLUSTERED  ([H_ScheduleType_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
