...
GO
ALTER TABLE [dbo].[L_ProviderOfficeScheduleUser] ADD CONSTRAINT [PK_L_ProviderOfficeScheduleUser] PRIMARY KEY CLUSTERED  ([L_ProviderOfficeScheduleUser_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
