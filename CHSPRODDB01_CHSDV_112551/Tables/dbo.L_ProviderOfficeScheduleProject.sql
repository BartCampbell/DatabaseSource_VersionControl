...
GO
ALTER TABLE [dbo].[L_ProviderOfficeScheduleProject] ADD CONSTRAINT [PK_L_ProviderOfficeScheduleProject] PRIMARY KEY CLUSTERED  ([L_ProviderOfficeScheduleProject_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
