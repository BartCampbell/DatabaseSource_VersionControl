...
GO
ALTER TABLE [dbo].[L_ProviderProviderMaster] ADD CONSTRAINT [PK_L_ProviderProviderMaster] PRIMARY KEY CLUSTERED  ([L_ProviderProviderMaster_RK]) WITH (FILLFACTOR=80) ON [PRIMARY]
GO
