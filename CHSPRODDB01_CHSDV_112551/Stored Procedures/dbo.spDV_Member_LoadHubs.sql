...
-- Description:	Load all Hubs from the Advantage tblMemberStagetable. (Based on [CHSDV].dbo.prDV_Member_LoadHubs)
-- =============================================
...
--** LOAD H_Member
		...
		DISTINCT        MemberHashKey ,
                        ...
                        LoadDate ,
                        RecordSource
                FROM    CHSStaging.adv.tblMemberStage WITH ( NOLOCK )
	...
	---*** LOAD H_Location
        INSERT  INTO H_Location
                SELECT  UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                        ...
                        LoadDate ,
                        RecordSource
                FROM    CHSStaging.adv.tblMemberStage
                WHERE   UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                          UPPER(CONCAT(RTRIM(LTRIM(COALESCE([Address],
                                                              ''))), ':',
                                                              RTRIM(LTRIM(COALESCE(ZipCode_PK,
