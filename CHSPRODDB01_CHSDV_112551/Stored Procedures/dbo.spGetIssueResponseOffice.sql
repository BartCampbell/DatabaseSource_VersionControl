...
AS
    ...
    -- Insert statements for procedure here
        ...
        FROM    dbo.H_IssueResponse h
                INNER JOIN dbo.S_IssueResponseDetail s ON s.H_IssueResponse_RK = h.H_IssueResponse_RK
                ...
                INNER JOIN dbo.LS_IssueResponseOfficeDetail ls ON ls.L_IssueResponseUserContactNotesOffice_RK = l.L_IssueResponseUserContactNotesOffice_RK
