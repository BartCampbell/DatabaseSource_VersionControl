...
--**S_SuspectChartRecLog LOAD
        ...
        INSERT  INTO [dbo].[S_SuspectChartRecLog]
                ...
                FROM    CHSStaging.adv.tblSuspectChartRecLogStage rw
                        INNER JOIN CHSStaging.adv.tblSuspectStage b WITH ( NOLOCK ) ON rw.Suspect_PK = b.Suspect_PK
                WHERE   UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
                                                          UPPER(CONCAT(RTRIM(LTRIM(COALESCE(rw.[User_PK],
                                                              ''))), ':',
                                                              RTRIM(LTRIM(COALESCE(rw.[Log_Date],
 ...
 --       INSERT  INTO [dbo].[LS_ScannedData]
 --               ( [LS_ScannedData_RK] ,
 --                 [LoadDate] ,
 ...
 --                                                             ''))), ':',
 --                                                             RTRIM(LTRIM(COALESCE(rw.[ScannedData_PK],
 --                                                             ''))), ':',
 ...
 --                                                             '')))))), 2)) ,
 --                       LoadDate ,
 --                       [SuspectUserDocumentHashKey] ,
 --                       [ScannedData_PK] ,
 --                       RTRIM(LTRIM([FileName])) ,
 --                       [dtInsert] ,
 --                       [is_deleted] ,
 --                       [CodedStatus] ,
 --                       UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
 --                                                         UPPER(CONCAT(RTRIM(LTRIM(COALESCE(rw.[ScannedData_PK],
 --                                                             ''))), ':',
 --                                                             RTRIM(LTRIM(COALESCE(rw.[FileName],
 --                                                             ''))), ':',
 --                                                             RTRIM(LTRIM(COALESCE(rw.[dtInsert],
 ...
 --                       SELECT  HashDiff
 --                       FROM    [LS_ScannedData]
 --                       WHERE   [L_SuspectUserDocument_RK] = rw.[SuspectUserDocumentHashKey]
 --                               AND RecordEndDate IS NULL )
 --                       AND rw.CCI = @CCI
 --               GROUP BY UPPER(CONVERT(CHAR(32), HASHBYTES('MD5',
 --                                                          UPPER(CONCAT(RTRIM(LTRIM(COALESCE(rw.CSI,
 ...
 --                       RecordSource;
	----RECORD END DATE CLEANUP
 --       UPDATE  dbo.LS_ScannedData
 --       SET     RecordEndDate = ( SELECT    DATEADD(ss, -1, MIN(z.LoadDate))
 --                                 FROM      dbo.LS_ScannedData z
 --                                 WHERE     z.LS_ScannedData_RK = a.LS_ScannedData_RK
 --                                           AND z.LoadDate > a.LoadDate
 --                               )
 --       FROM    dbo.LS_ScannedData a
 --       WHERE   a.RecordEndDate IS NULL; 
