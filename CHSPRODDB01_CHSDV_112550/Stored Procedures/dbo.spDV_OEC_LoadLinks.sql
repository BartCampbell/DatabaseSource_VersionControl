...
-- Usage:			
--		  EXECUTE dbo.spDV_OEC_LoadLinks
-- =============================================

CREATE PROCEDURE [dbo].[spDV_OEC_LoadLinks]
AS
    BEGIN
		  ...
		  --LOAD MemberOEC Link
            INSERT  INTO dbo.L_MemberOEC
                    ...
                    SELECT DISTINCT
                            ...
                            LoadDate ,
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112550
		  ...
		  --LOAD L_OECProviderNetwork Link
            INSERT  INTO dbo.L_OECProviderNetwork
                    ...
                    SELECT DISTINCT
                            ...
                            LoadDate
                    FROM    CHSStaging.oec.AdvanceOECRaw_112550
                    WHERE   ISNULL(H_Network_RK, '') <> ''
                            AND L_OECProviderNetwork_RK NOT IN ( SELECT L_OECProviderNetwork_RK
		  ...
		  --LOAD L_OECVendorContact Link
            INSERT  INTO dbo.L_OECVendorContact
                    ...
                    WHERE   Contact_BK_Vendor <> ''
                            AND L_OECVendorContact_RK NOT IN ( SELECT   L_OECVendorContact_RK
		  ...
		  --LOAD L_OECProviderContact Link
            INSERT  INTO dbo.L_OECProviderContact
                    ...
                    WHERE   L_OECProviderContact_RK IS NOT NULL
                            AND L_OECProviderContact_RK NOT IN ( SELECT L_OECProviderContact_RK
		  ...
		  --LOAD L_OECVendorLocation Link
            INSERT  INTO dbo.L_OECVendorLocation
                    ...
                    WHERE   Location_BK_Vendor <> ''
                            AND L_OECVendorLocation_RK NOT IN ( SELECT  L_OECVendorLocation_RK
		  ...
		  --LOAD L_OECProviderLocation Link
            INSERT  INTO dbo.L_OECProviderLocation
                    ...
                    WHERE   L_OECProviderLocation_RK IS NOT NULL
                            AND L_OECProviderLocation_RK NOT IN ( SELECT    L_OECProviderLocation_RK
		  ...
		  --LOAD ProviderSpecialty Link
            INSERT  INTO dbo.L_ProviderSpecialty
                    ...
                    SELECT DISTINCT
                            ...
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112550
                    WHERE   L_ProviderSpecialty_RK NOT IN ( SELECT  L_ProviderSpecialty_RK
		  ...
		  --LOAD OECProjectOEC Link
            INSERT  INTO dbo.L_OECProjectOEC
                    ...
                    SELECT DISTINCT
                            ...
                            FileName
                    FROM    CHSStaging.oec.AdvanceOECRaw_112550
                    WHERE   L_OECProjectOEC_RK NOT IN ( SELECT  L_OECProjectOEC_RK
