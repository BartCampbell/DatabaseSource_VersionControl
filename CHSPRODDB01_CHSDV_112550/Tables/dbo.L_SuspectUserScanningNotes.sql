...
GO
ALTER TABLE [dbo].[L_SuspectUserScanningNotes] ADD CONSTRAINT [PK_L_SuspectUserScanningNotes] PRIMARY KEY CLUSTERED  ([L_SuspectUserScanningNotes_RK]) ON [PRIMARY]
GO
