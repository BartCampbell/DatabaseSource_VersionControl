...
BEGIN
	...
	BEGIN
		INSERT INTO tblProviderOfficeInvoice(InvoiceAmount,InvoiceNumber,InvoiceVendor_PK,ProviderOffice_PK) VALUES(@invoiceAmount,@invoiceNumber,@invoiceVendor,@office)
