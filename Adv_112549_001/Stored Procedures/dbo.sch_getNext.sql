...
BEGIN
	...
	EXEC sch_getOffice @Projects='0', @ProjectGroup='0', @Page=1, @PageSize=1, @Alpha='', @Sort='', @Order='', @Provider=0, @bucket=0, @followup_bucket=0, @user=@user, @scheduler=0, @PoolPK=0, @ZonePK=0, @OFFICE=@ProviderOffice_PK,@address=''
END
GO
