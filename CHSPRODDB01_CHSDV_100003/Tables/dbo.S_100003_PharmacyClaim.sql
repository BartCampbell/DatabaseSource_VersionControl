CREATE TABLE [dbo].[S_100003_PharmacyClaim]
(
...
[S_100003_PharmacyClaim_RK] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[H_100003_Member_RK] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[S_100003_PharmacyClaim] ADD CONSTRAINT [PK__S_100003__6E0C4FE03CCA7526] PRIMARY KEY CLUSTERED  ([S_100003_PharmacyClaim_RK]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IDX_FromDate] ON [dbo].[S_100003_PharmacyClaim] ([FROM_DATE]) INCLUDE ([ATT_PROV], [ATT_PROV_SPEC], [CLAIM_ID], [ClientMemberID], [NDC], [SV_LINE]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[S_100003_PharmacyClaim] ADD CONSTRAINT [FK_S_100003_PharmacyClaim_H_100003_Member] FOREIGN KEY ([H_100003_Member_RK]) REFERENCES [dbo].[H_100003_Member] ([H_Member_RK])
GO
