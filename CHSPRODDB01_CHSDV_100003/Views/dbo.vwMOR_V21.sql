...
FROM 
   (select h.recordsource, h.ContractNumber, h.PaymentYearandMonth, 'V21' AS RecordTypeCode, b.HICN, b.LastName, b.FirstName
	...
	inner join CHSDV.dbo.S_MOR_BRecord b on h.H_MOR_Header_RK = b.H_MOR_Header_RK ) p
UNPIVOT
   (present FOR HCC IN  
